# Unidad 09 — Física Contemporánea

**Páginas objetivo:** 35
**Manual:** Física Albatros
**Case study:** Equipo F1 Albatros
**Episodio en esta unidad:** Energías limpias para la flota escolar futura.

## Subtemas

| ID | Título | pp |
|---|---|---:|
| 9.1 | Estructura atómica (modelos, Rutherford, Bohr) | 8 |
| 9.2 | Física nuclear (radiactividad, fisión, fusión) | 10 |
| 9.3 | Otras formas de energía (solar, eólica, geotérmica, H₂) | 8 |
