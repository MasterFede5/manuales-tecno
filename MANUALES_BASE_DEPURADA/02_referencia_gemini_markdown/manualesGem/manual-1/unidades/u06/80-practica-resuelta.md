...
Una inspección STPS detectaría incumplimiento de NOM-018 (multa típica \$50,000-\$200,000) y NOM-052 (multa típica \$100,000-\$500,000). **Riesgo total: \$150,000 a \$700,000 MXN.**

Más grave: si un alumno sufre un accidente con cloro y se determina que la escuela no tenía las medidas obligatorias, hay **responsabilidad civil y posiblemente penal** del director.
...
> El sistema actual del bebedero **está fuera de norma** en al menos 3 NOM (018, 052, 127), con riesgo de sanción de hasta \$700,000 MXN y, lo más importante, riesgo a la salud de los estudiantes. Proponemos un plan de remediación de 90 días con inversión de \$14,250 MXN que pondrá al sistema en cumplimiento total. La inversión equivale al **2 % del riesgo de sanción mínima** y, sobre todo, al **costo de hacer las cosas bien**.
::/practica
...
**Paso 8 — Conclusión.**
> La etiqueta cumple NOM-018-STPS si incluye los dos pictogramas (GHS05 y GHS09), la palabra "Peligro", tres frases H y siete frases P, datos del proveedor, lote y fecha. Costo de impresión: ≈ \$30 MXN por etiqueta, despreciable frente a la sanción típica de \$50–200k. Esta práctica conecta directamente con la **Implementación Albatros** de auditoría.
::/practica
...
> El lodo **no es residuo peligroso** si la prueba T (toxicidad por lixiviado) sale negativa. Es un residuo de **manejo especial**, regulado por la legislación estatal.

**Paso 4 — Considera el caso T positivo.**
Si el laboratorio detecta plomo > 5 mg/L en el lixiviado (umbral NOM-052), entonces el lodo sí es RP. Esto puede ocurrir si la cisterna o tinaco tienen soldaduras antiguas. En tal caso, gestiona como RP-CT con NOM-052.

**Paso 5 — Costo de gestión escenario "no peligroso".**
- 5 kg/semana × 52 semanas = 260 kg/año.
- Disposición como manejo especial: ≈ \$3 MXN/kg → **\$780 MXN/año**.
- Posible reuso: el lodo (mayoría CaCO₃) puede usarse como mejorador de suelos ácidos en jardín escolar → costo cero y aporta al ciclo verde.

**Paso 6 — Costo de gestión escenario "peligroso".**
- Empresa autorizada NOM-052: ≈ \$25–40 MXN/kg.
- 260 kg/año × \$30 = **\$7,800 MXN/año**, 10× más caro que el escenario no peligroso.

**Paso 7 — Recomendación.**
> Realiza la prueba CRT inicial (≈ \$1,500 MXN, una sola vez). Si negativa, gestiona como manejo especial o, mejor, **reutiliza** los lodos en el jardín escolar (aplicación máxima 100 g/m² al año). Si positiva, contrata empresa NOM-052. Documenta en bitácora con fecha, peso y destino. Esto cumple NOM-052 y aplica el principio 1 de química verde (prevención de residuos).
::/practica
