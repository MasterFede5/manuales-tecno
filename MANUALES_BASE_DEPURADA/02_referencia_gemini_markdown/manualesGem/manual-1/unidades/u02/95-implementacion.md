...
::visual{tipo="interfaz" descripcion="Captura del dashboard final en Adafruit IO mostrando dos gráficas en tiempo real (pH y TDS) con datos de 24 horas, con líneas horizontales que marcan los límites de la NOM-127, y un panel lateral con estadísticas (media, máximo, mínimo) y alertas activas." paginas="0.5" src="../manualesGem/assets/visuales/manual-1/u02/95-implementacion-v01.svg"}
