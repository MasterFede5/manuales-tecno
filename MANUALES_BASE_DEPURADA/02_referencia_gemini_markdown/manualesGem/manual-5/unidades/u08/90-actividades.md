...
**Pregunta detonadora.** Si tu coordinadora puede usar tu predictor desde su navegador sin abrir Colab, ¿qué cambia en su día a día?
...
**Materiales.** Anthropic API key (Claude), OpenAI key (embeddings), 3 PDFs institucionales, GitHub, Streamlit Cloud, 6 horas.
