...
**Pregunta detonadora.** Si tuvieras que defender ante un consejo educativo "qué predice el rendimiento", ¿qué números pondrías y cuáles **no afirmarías** aunque las correlaciones lo sugieran?
...
El director ve `r(asistencia, cal_final) = 0.55` y propone: "vamos a hacer **obligatorio** que todos lleguen al 95% de asistencia; esto **causará** que el promedio suba 0.5 puntos".

**Pregunta.** Tu rol es asesor estadístico. Redacta una respuesta de 5–8 líneas que:
1. Reconozca la correlación (es real).
2. Explique por qué la afirmación causal **NO se sigue** de la correlación.
3. Proponga 1 confounder plausible.
4. Sugiera **qué tipo de evidencia** convertiría la propuesta en defendible (experimento, estudio cuasi-experimental).
::/act-case
...
**Pregunta detonadora.** Si recibes 5 afirmaciones de un consultor sobre el rendimiento escolar, ¿puedes auditar cuáles son defendibles y cuáles van más allá de la evidencia?
