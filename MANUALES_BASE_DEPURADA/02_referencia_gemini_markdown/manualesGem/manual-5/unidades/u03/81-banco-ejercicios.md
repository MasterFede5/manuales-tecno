...
> Practica visualización con matplotlib y seaborn. Cada ejercicio te pide **escribir o leer** código de gráficos.
...
**Pregunta.** Escribe en 4–6 líneas qué le dirías al consejo: 1) qué materia preocupa más y por qué; 2) qué materia está mejor; 3) qué casos individuales merecen atención.
::/act-case
...
- `act-case`: respuesta modelo:
  > "Matemáticas concentra el problema: mediana 6.0 (apenas pasa) y dispersión más alta (IQR 4.5–7.5) con outliers en ambos extremos. Química está mejor (mediana 8.0). Atención individual: el outlier de 2.0 en Mate y el de 3.5 en Química son alumnos en riesgo agudo."
- `act-mcq`: 1·B, 2·B.
...
> **Cierre.** Si tus gráficos llevan título, ejes etiquetados y un mensaje claro, ya pasaste el filtro mínimo del consejo académico.
