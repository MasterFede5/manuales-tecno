...
**Pregunta.** Lista los 4 errores específicos del gráfico y describe cómo cada uno **engaña al lector** (1 línea por error). Bonus: ¿qué ley o principio ético podrías invocar?
::/act-case
...
**Tu tarea.**
1. Identifica los 6 problemas (figura sin tamaño, sin título, sin ejes etiquetados, paleta no institucional, sin meta, sin valores anotados).
2. Refactoriza usando el patrón profesional (figsize, ax, title, xlabel, ylabel, anotaciones, colores condicionales si <80, meta).
