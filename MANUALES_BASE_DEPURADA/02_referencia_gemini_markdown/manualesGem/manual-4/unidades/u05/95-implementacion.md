...
::visual{tipo="ilustracion" descripcion="Mockup del ecosistema en operación: en el centro, un cuadro 'Workflows Albatros' con 3 sub-cuadros (Inscripción, Información, Reporte). De cada uno salen flechas a las plataformas externas (Notion, Airtable, Gmail, Calendar, Slack). Bajo el ecosistema, dashboard de monitoreo con métricas reales (tasa éxito, latencia, costo, alertas). A la izquierda, repo Git con tags v1.0.0 por cada workflow. Estilo blueprint Albatros." paginas="1" src="../manualesGem/assets/visuales/manual-4/u05/95-implementacion-v01.svg"}
