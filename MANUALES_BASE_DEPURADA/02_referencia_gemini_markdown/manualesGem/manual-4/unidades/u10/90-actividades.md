...
Tu plan a 12 meses fue presentado al patronato. La presidenta pregunta: "Veo que el TCO sube 40% del Q1 al Q4. ¿Por qué? ¿Estamos perdiendo control?". Tienes 5 minutos para responder en vivo.

Diseña tu respuesta en 5 actos: (1) reconoces la observación; (2) explicas que el aumento es por crecimiento de adopción, no descontrol; (3) muestras la métrica de TCO/usuario que se mantiene estable; (4) presentas las 3 técnicas de optimización que aplicarás en Q3-Q4 para mantener el ratio; (5) ofreces revisión mensual con el comité de gobernanza. Mínimo 12 líneas.
::/act-case
...
**Lo que harás.**
1. Recolecta resultados del piloto IA en tu institución (o usa proyectado si no tienes piloto).
2. Aplica las 5 técnicas de la unidad:
   - **10.1**: Recomendación de proveedores con cálculo concreto.
   - **10.2**: TCO mensual + 3 técnicas de optimización aplicadas con ahorros estimados.
   - **10.3**: Política de uso v1.0 (2 páginas).
   - **10.4**: 8 KPIs con baseline y objetivos a 12 meses.
   - **10.5**: Matriz dato × sistema personalizada.
3. Roadmap trimestral con 4 hitos por trimestre.
4. Plan de salida con escenarios cancelación mes 6 y mes 12.
5. Documento final de 6-8 páginas listo para firmas.
6. Presentación de 20 minutos (slides + dashboard) para patronato.

**Materiales.** Datos del piloto, software de presentaciones, 6 horas.
