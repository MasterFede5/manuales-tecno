...
> Banco extendido para reforzar el dominio de las 4 plataformas conversacionales (ChatGPT, Claude, Gemini, Copilot). Privilegia ejercicios de **redacción de prompts**, **comparación de respuestas** y **detección de limitaciones**. Resuelve antes de mirar la clave.
