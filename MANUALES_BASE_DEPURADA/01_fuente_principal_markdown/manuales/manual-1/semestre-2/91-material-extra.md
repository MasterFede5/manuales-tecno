...
- **Alimentos** conecta con la unidad final del semestre porque sienta las bases que ahí se aplican.
- **Seguridad Industrial** prepara el terreno para el próximo semestre o manual.
...
- 🌐 **Web** · ChemLibreTexts.
- 🎓 **OCW** · SEMARNAT.
- 📺 **Video** · Crash Course Chemistry.
- 📰 **Artículo** · Lectura breve sobre el case study **Agua escolar saludable** (consulta con tu docente la referencia local).
...
Diseña una **infografía A3** que conecte las 3 unidades del semestre
en torno al case study **Agua escolar saludable**. Debe incluir:
- El problema inicial.
- Una herramienta por unidad.
- La evidencia que producirá cada unidad.
- La conexión con el siguiente semestre.

Compártela con #AlbatrosManual1.
::/act-challenge

::act-mcq{titulo="Repaso transversal de opción múltiple"}
1. La función principal del case study **Agua escolar saludable** en este manual es:
