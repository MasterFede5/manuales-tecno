...
Este semestre del manual *Química Albatros* fue construido sobre tres principios
metodológicos que conviene tener presentes para sacarle el máximo provecho:

::concepto{titulo="Principios metodológicos"}
1. **Aprendizaje basado en proyectos (ABP).** El case study **"Agua escolar saludable"** es el hilo conductor único: cada unidad agrega una herramienta para resolverlo.
