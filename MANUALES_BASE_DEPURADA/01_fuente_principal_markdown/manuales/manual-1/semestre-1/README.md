# Semestre 1 — Manual 1: Química Albatros

**Unidades de este semestre:** U00 (Lenguaje del Químico), U01 (Temas Básicos de la Materia), U02 (Agua), U03 (Aire)
...
python print_to_pdf.py --manual 1 --semester 1
```
