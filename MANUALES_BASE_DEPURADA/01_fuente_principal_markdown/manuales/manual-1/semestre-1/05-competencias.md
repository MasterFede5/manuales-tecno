...
# Índice de competencias — Semestre 1

## Competencia eje del semestre

> **Aplicar el método científico para investigar fenómenos químicos relevantes para la salud y el ambiente escolar.**

## Mapeo unidad → competencia → evidencia

| ID | Competencia | Verbo Bloom | Evidencia esperada | Reactivo |
|---|---|---|---|---|
| 1.00.A | Lenguaje del Químico — competencia A | Aplicar | Práctica resuelta + Implementación de la unidad | U00-A |
| 1.00.B | Lenguaje del Químico — competencia B | Analizar | Banco de ejercicios + Taller de la unidad | U00-B |
| 1.01.A | Temas Básicos de la Materia — competencia A | Aplicar | Práctica resuelta + Implementación de la unidad | U01-A |
| 1.01.B | Temas Básicos de la Materia — competencia B | Analizar | Banco de ejercicios + Taller de la unidad | U01-B |
| 1.02.A | Agua — competencia A | Aplicar | Práctica resuelta + Implementación de la unidad | U02-A |
| 1.02.B | Agua — competencia B | Analizar | Banco de ejercicios + Taller de la unidad | U02-B |
| 1.03.A | Aire — competencia A | Aplicar | Práctica resuelta + Implementación de la unidad | U03-A |
| 1.03.B | Aire — competencia B | Analizar | Banco de ejercicios + Taller de la unidad | U03-B |
