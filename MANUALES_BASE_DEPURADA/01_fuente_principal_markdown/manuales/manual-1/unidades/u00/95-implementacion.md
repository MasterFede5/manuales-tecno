...
::visual{tipo="interfaz" descripcion="Captura de la plantilla terminada en Google Sheets: lado izquierdo con la tabla de mediciones (columnas A-F llenas con 5 datos del pH del bebedero), lado derecho con el bloque de fórmulas (H1:I8) mostrando los resultados calculados automáticamente y celda final destacada con 'pH = 7.06 ± 0.01'. Paleta azul-naranja Albatros." paginas=0.5}
