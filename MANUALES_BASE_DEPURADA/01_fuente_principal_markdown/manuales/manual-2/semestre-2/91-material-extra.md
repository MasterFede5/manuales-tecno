...
- **Electromagnetismo** conecta con la unidad final del semestre porque sienta las bases que ahí se aplican.
- **Física Contemporánea** prepara el terreno para el próximo semestre o manual.
...
- 🎓 **OCW** · MIT OCW (8.01).
- 📺 **Video** · CERN.
- 📰 **Artículo** · Lectura breve sobre el case study **Equipo F1 Albatros** (consulta con tu docente la referencia local).
...
en torno al case study **Equipo F1 Albatros**. Debe incluir:
- El problema inicial.
- Una herramienta por unidad.
- La evidencia que producirá cada unidad.
- La conexión con el siguiente semestre.

Compártela con #AlbatrosManual2.
::/act-challenge

::act-mcq{titulo="Repaso transversal de opción múltiple"}
1. La función principal del case study **Equipo F1 Albatros** en este manual es:
