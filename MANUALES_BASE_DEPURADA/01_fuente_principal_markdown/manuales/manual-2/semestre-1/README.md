# Semestre 1 — Manual 2: Física Albatros

**Unidades de este semestre:** U01 (Cinemática), U02 (Dinámica), U03 (Trabajo y Energía), U04 (Termodinámica), U05 (Ondas y Sonido)
...
```bash
python build/converter.py manuales/manual-2 dist/manual-2-sem-1.html --semester 1
python print_to_pdf.py --manual 2 --semester 1
```
