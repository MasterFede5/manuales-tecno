...
Bienvenido al **Semestre 1** del manual *Física Albatros*. Lo que tienes en
...
**Tu misión durante este semestre.** Tu escuela compite en la liga nacional de F1 in Schools. Te encargan el diseño físico, instrumentación y telemetría del coche. Cada unidad te da una nueva herramienta de la física para mejorarlo.

Vas a recorrer las unidades **U01, U02, U03, U04, U05** y al final
podrás demostrar que dominas la competencia central:

> *Modelar el comportamiento físico de un sistema real y validarlo con instrumentación y datos.*
