...
- **Redes neuronales básicas** conecta con la unidad final del semestre porque sienta las bases que ahí se aplican.
- **Publicación y despliegue** prepara el terreno para el próximo semestre o manual.
...
- 🌐 **Web** · Real Python.
- 🎓 **OCW** · scikit-learn user guide.
- 📺 **Video** · Pandas docs.
- 📰 **Artículo** · Lectura breve sobre el case study **Predictor de rendimiento escolar** (consulta con tu docente la referencia local).
...
Diseña una **infografía A3** que conecte las 4 unidades del semestre
en torno al case study **Predictor de rendimiento escolar**. Debe incluir:
- El problema inicial.
- Una herramienta por unidad.
- La evidencia que producirá cada unidad.
- La conexión con el siguiente semestre.

Compártela con #AlbatrosManual5.
::/act-challenge

::act-mcq{titulo="Repaso transversal de opción múltiple"}
1. La función principal del case study **Predictor de rendimiento escolar** en este manual es:
