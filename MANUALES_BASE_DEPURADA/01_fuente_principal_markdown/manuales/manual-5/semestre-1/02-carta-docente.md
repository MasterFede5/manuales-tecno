...
Este semestre del manual *Inteligencia Artificial con Programación* fue construido sobre tres principios
metodológicos que conviene tener presentes para sacarle el máximo provecho:

::concepto{titulo="Principios metodológicos"}
1. **Aprendizaje basado en proyectos (ABP).** El case study **"Predictor de rendimiento escolar"** es el hilo conductor único: cada unidad agrega una herramienta para resolverlo.
...
**Ritmo sugerido del semestre.** 4 unidades × aproximadamente
