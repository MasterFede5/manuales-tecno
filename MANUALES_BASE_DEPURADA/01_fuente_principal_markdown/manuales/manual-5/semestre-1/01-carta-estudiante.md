...
Bienvenido al **Semestre 1** del manual *Inteligencia Artificial con Programación*. Lo que tienes en
...
**Tu misión durante este semestre.** La coordinación académica te entrega un dataset anonimizado con horas de estudio, asistencia, calificaciones previas y resultado final. Tu misión: construir paso a paso un sistema que prediga el rendimiento de un estudiante y lo explique en lenguaje natural.

Vas a recorrer las unidades **U01, U02, U03, U04** y al final
podrás demostrar que dominas la competencia central:

> *Construir, evaluar y publicar un modelo de ML completo con Python, datos reales y APIs de IA.*
