...
::interioriza
Imagina que entrenar un modelo es como estudiar para un examen usando ejercicios resueltos.
- **Train:** Estudiar los ejercicios pasados.
- **Test:** El examen final con preguntas nuevas.
- **Overfitting:** Memorizar las respuestas pasadas sin entender, reprobando el examen final.
::/interioriza

::pausa{}
**Reflexiona:**
- Si un modelo memoriza los datos, ¿qué pasará con su error en entrenamiento?
- ¿Y qué pasará con su error en datos nuevos?
::/pausa
...
**Lo que harás.**
- Implementa pipeline completo de la práctica resuelta.
- Entrena 3 modelos: Linear, Tree (depth=4), Random Forest.
- Compara con tabla de métricas (R², RMSE, gap, CV).
- Diagnostica overfitting en cada uno.
- Guarda el mejor modelo con joblib.
- Crea función `predecir_riesgo(alumno_dict)` que devuelve probabilidad.
- Documenta resultado y limitaciones.
...
- ¿Hay overfit? ¿Por qué?
- Da 3 cambios al modelo para reducirlo (con valores).
- ¿Cómo verificas si tu cambio funcionó y qué métrica miras?
::/act-case
...
- **Nodos requeridos:** features, split, modelo, métrica, validación, decisión.
- **Detalle:** Incluye 2 ejemplos por cada nodo.
::/act-mindmap
...
**Lo que harás.**
- Toma tu modelo Linear actual (R² ≈ 0.61).
- Crea al menos 4 features derivadas y prueba su impacto:
...
- Agrega cada feature nueva al modelo, mide R² y decide si la conservas.
- Documenta cuáles funcionaron y cuáles no.
