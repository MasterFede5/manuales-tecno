...
- Aprender a programar es como entrenar un músculo.
- Este banco de ejercicios es tu rutina de peso libre.
- No levantes la barra (las respuestas) hasta sudar la camiseta.
::/interioriza

> - Aquí practicas las 7 piezas de Python.
> - No leas la clave de respuestas hasta intentar cada bloque.
> - Si te trabas más de 5 min, salta al siguiente y vuelve después.

::pausa{}
1. ¿Cuál es el propósito de intentar primero sin ver las respuestas?
2. ¿Por qué es útil poner un límite de 5 minutos por bloque?
::/pausa
...
- La coordinación reportó que **al cargar el CSV crashea en la línea 47**.
- La fila luce así:
```
427,3.5,N/A,7.0,8.5
```
- Tu programa hace `float(fila["asistencia"])` y revienta.
- Diseña en pseudocódigo (3-5 líneas) cómo deberías modificar tu función `parsear_fila` para:
...
> **Cierre.** 
> - Si resolviste >70 % sin mirar la clave, estás listo para U2.
> - Si <50 %, repasa el subtema correspondiente.
> - Recuerda que cada bloque mapea 1-1 con un subtema 1.X.
