...
Este semestre del manual *Inteligencia Artificial Básica* fue construido sobre tres principios
metodológicos que conviene tener presentes para sacarle el máximo provecho:

::concepto{titulo="Principios metodológicos"}
1. **Aprendizaje basado en proyectos (ABP).** El case study **"Mi tutor IA personal"** es el hilo conductor único: cada unidad agrega una herramienta para resolverlo.
