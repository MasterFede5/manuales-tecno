...
Bienvenido al **Semestre 2** del manual *Inteligencia Artificial Básica*. Lo que tienes en
...
**Tu misión durante este semestre.** A lo largo del manual construyes tu propio asistente IA personal: primero conversas con él, luego le das contexto, lo personalizas, le agregas multimedia, lo conviertes en GPT propio y lo publicas bajo principios éticos. Cada unidad le suma una capa.

Vas a recorrer las unidades **U06, U07, U08, U09** y al final
podrás demostrar que dominas la competencia central:

> *Usar IA generativa con criterio, ética y prompts efectivos para producir conocimiento propio.*
