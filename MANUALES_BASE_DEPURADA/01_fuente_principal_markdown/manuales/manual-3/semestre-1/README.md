# Semestre 1 — Manual 3: Inteligencia Artificial Básica

**Unidades de este semestre:** U01 (Fundamentos e Historia de la IA), U02 (Tu primer chat útil), U03 (Prompts que sí funcionan), U04 (Voz, imagen y video con IA), U05 (IA que estudia un PDF contigo)
...
las carpetas `u01`, `u02`, `u03`, `u04`, `u05`.
...
```bash
python build/converter.py manuales/manual-3 dist/manual-3-sem-1.html --semester 1
python print_to_pdf.py --manual 3 --semester 1
```
