...
- **Fundamentos e Historia de la IA** conecta con la unidad final del semestre porque sienta las bases que ahí se aplican.
- **IA que estudia un PDF contigo** prepara el terreno para el próximo semestre o manual.
...
- 🌐 **Web** · Anthropic Learn.
- 🎓 **OCW** · Google AI Studio docs.
- 📺 **Video** · OpenAI Cookbook.
- 📰 **Artículo** · Lectura breve sobre el case study **Mi tutor IA personal** (consulta con tu docente la referencia local).
...
en torno al case study **Mi tutor IA personal**. Debe incluir:
- El problema inicial.
- Una herramienta por unidad.
- La evidencia que producirá cada unidad.
- La conexión con el siguiente semestre.

Compártela con #AlbatrosManual3.
::/act-challenge

::act-mcq{titulo="Repaso transversal de opción múltiple"}
1. La función principal del case study **Mi tutor IA personal** en este manual es:
