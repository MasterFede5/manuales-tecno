...
# Mapa de contenidos — Semestre 1

| Unidad | Tema central | Duración sugerida | Aporte al caso |
|---|---|---|---|
| U01 | Fundamentos e Historia de la IA | 3–4 semanas | Episodio del case que toca |
| U02 | Tu primer chat útil | 3–4 semanas | Episodio del case que toca |
| U03 | Prompts que sí funcionan | 3–4 semanas | Episodio del case que toca |
| U04 | Voz, imagen y video con IA | 3–4 semanas | Episodio del case que toca |
| U05 | IA que estudia un PDF contigo | 3–4 semanas | Episodio del case que toca |

::visual{tipo="infografia" descripcion="Infografía vertical tipo mapa visual del semestre 1 del manual Inteligencia Artificial Básica: en la parte superior, el título del case study 'Mi tutor IA personal'. Debajo, una columna de 5 estaciones conectadas verticalmente, una por unidad (u01, u02, u03, u04, u05), cada estación con su número, título, ícono temático y la herramienta que aporta al caso. Al pie, un entregable de portafolio final del semestre. Paleta azul Albatros + naranja en conectores." paginas=1 nota="mapa visual del semestre — pieza central del front matter"}
