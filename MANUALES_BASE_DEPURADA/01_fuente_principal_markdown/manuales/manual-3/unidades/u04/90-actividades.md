...
::interioriza
Imagina que las IA generativas son los músicos de una orquesta. ElevenLabs es tu cantante, Midjourney es tu escenógrafo, y Sora es tu director de video.
Si coordinas a todos, obtienes una sinfonía multimedia perfecta.
::/interioriza

::pausa{}
¿Cuál crees que es el rol más difícil de reemplazar en esta "orquesta" y por qué?
::/pausa
...
* Genera el _____________ con un LLM (ChatGPT, Claude).
* Genera _____________ con DALL·E o Midjourney.
* Convierte texto en _____________ con ElevenLabs.
* Genera música de fondo con _____________.
* Si quieres avatar hablante, usas _____________.
* Editas y montas en _____________ o Descript.

La función _____________ de Descript permite editar audio/video escribiendo en el transcript.
La herramienta open source _____________ transcribe audio en 99 idiomas gratis.
::/act-fill
...
**Pregunta detonadora.**
* ¿Puedes producir contenido educativo profesional en 1 hora usando solo IA generativa?

**Lo que harás.**
* Elige un tema de tu materia favorita (1-2 conceptos clave).
* Sigue el pipeline de la práctica resuelta paso a paso.
* Genera: guion, 6 imágenes, voz, música, opcionalmente avatar HeyGen.
* Edita en CapCut o Descript (60 s exacto).
* Exporta MP4 con subtítulos.
* Publica en redes (YouTube Shorts, TikTok, Instagram) con hashtags #IAEducativa.
* Recolecta retroalimentación de 3 personas (qué entendieron, qué les gustó).
* Documenta el proceso.

**Materiales.**
* Cuentas: ChatGPT/Claude, DALL·E/Midjourney, ElevenLabs, Suno, CapCut.
* Tiempo: 90 min.
...
**Tu tarea:**
* Pide a tres compañeros 3 imágenes y 3 videos recientes de redes sociales.
* Tu trabajo: detectar cuáles son generados por IA.

**Para cada pieza:**
* Anota 3 señales visuales/auditivas que delataron a la IA.
* Fíjate en manos defectuosas, texto ilegible, sombras raras o voces robóticas.
* Decide tu nivel de confianza (alto / medio / bajo).
* Verifica con metadatos (tags C2PA) o detectores como AI or Not.
* Reflexiona: ¿qué piezas te engañaron y por qué?
::/act-case
...
* **6 ramas:** guion, imagen, voz, música, avatar, edición.
* **3 hojas por rama:** herramienta principal, plan recomendado, limitación a recordar.
::/act-mindmap

---

::act-label{titulo="Etiqueta el flujo de producción multimedia"}
::visual{tipo="diagrama-flujo" descripcion="Diagrama de flujo horizontal con 6 cajas vacías que representan los pasos de un pipeline multimedia: idea → guion → imagen → voz → música → edición → video final. Cada caja tiene espacio para que el estudiante anote la herramienta usada, el tiempo aproximado y el formato del archivo de salida. Debajo del diagrama, una línea de tiempo total con marcadores cada 15 minutos." paginas=0.5}

* Etiqueta cada caja con la herramienta y el formato de salida.
* Suma los tiempos para tener el budget total del pipeline.
::/act-label
...
* Escribe en la parte de abajo qué término crees que va a desaparecer en 2 años.
::/act-puzzle
...
**Pregunta detonadora.**
* ¿Cuánto contenido multimedia puedes producir con presupuesto cero?

**Lo que harás.**
* **Identifica 5 herramientas** con plan free generoso.
* **Reproduce el pipeline** del taller pero usando solo herramientas gratis.
* **Documenta los límites:** cuántas imágenes, calidad, tiempos de espera.
* **Compara:** contrasta contra una pieza producida con plan pago.
* **Calcula el umbral:** ¿en qué punto vale la pena pagar suscripción?

**Materiales.**
* Internet y cronómetro.
* Planes free de las 5 herramientas.

**Entregable.**
* Tabla de las 5 herramientas free con cuotas.
* Pieza producida (video corto).
* Comparativa con pieza paga.
* Recomendación justificada: ¿pagas o no?
