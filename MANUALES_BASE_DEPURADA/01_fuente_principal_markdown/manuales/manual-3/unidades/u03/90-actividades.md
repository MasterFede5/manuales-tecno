...
::interioriza
Piensa en los prompts como los planos que le das a un arquitecto.
- Si le dices "Haz una casa" (Zero-shot), puede hacer cualquier cosa.
- Si le muestras un boceto y le das medidas exactas (Few-shot y R-T-C-R-F-E), construirá justo lo que necesitas.
::/interioriza

::pausa{}
**Deduce:**
- ¿Por qué crees que un "mega-prompt" de 50 líneas a veces da peores resultados que uno corto y estructurado?
::/pausa
...
La técnica de pedir al modelo "_____________" antes de responder:
- Mejora dramáticamente la matemática y la lógica.

Para tareas con formato custom:
- Conviene dar _____________ ejemplos al modelo (3 a 5 suelen ser óptimos).
::/act-fill
...
**Pregunta detonadora.** 
- ¿Cómo cambia la respuesta del modelo si le aplicas 5 técnicas distintas a la misma tarea?

**Lo que harás.**
1. Define una tarea concreta de tu vida real.
   - Ej: "Genera plan de estudio para examen de admisión UNAM".
2. Resuelvela con 5 prompts distintos:
   ...
   - **Few-shot:** prompt con anatomía + 1 ejemplo de plan.
   - **Chain-of-thought:** prompt con anatomía + "piensa paso a paso".
   - **Combinación:** anatomía + few-shot + CoT + structured output JSON.
3. Compara las 5 respuestas en tabla con criterios: 
   - Utilidad, estructura, personalización, tiempo de respuesta, longitud.
4. Identifica cuál técnica funcionó mejor para esta tarea específica.
5. Reflexiona: 
   - ¿Siempre es mejor la técnica más compleja? ¿Cuándo basta zero-shot?

**Materiales.** 
- Acceso a tu plataforma elegida. 
- 60 min.
- Hoja de cálculo o Notion para la comparativa.

**Entregable.** 
- Reporte de 1-2 páginas con las 5 respuestas (capturas o copy-paste).
- Tabla comparativa.
- Conclusión sobre la técnica ganadora **para tu tarea específica**.
...
A continuación tres prompts reales que un compañero te muestra. Para cada uno: 
- a) Identifica los antipatrones presentes.
- b) Reescríbelo con la anatomía R-T-C-R-F-E.
- c) Anota qué capas agregaste.
...
**Pregunta detonadora.** 
- Algunos dicen que *prompt engineering* es la habilidad más importante del siglo XXI. 
- Otros dicen que es un parche temporal hasta que los modelos "entiendan mejor". 
- ¿Quién tiene razón?

**Lo que harás.**
1. Forma equipos de 4. 
   - Dos defienden "es habilidad esencial duradera".
   - Dos defienden "es parche temporal".
2. Investiga 30 minutos: 
   - Declaraciones de expertos (Andrej Karpathy, Ethan Mollick, Yann LeCun).
   - Evolución de capacidad de "instruction-following" entre GPT-3.5 y GPT-5.
3. Estructura tu argumento en 3 puntos: 
   - Definición de prompting que usas, evidencia empírica, predicción a 5 años.
4. Debate 15 minutos y vota anonimamente.
5. Cierre individual: 
   - ¿Cómo cambia tu inversión personal en aprender prompting si crees una postura u otra?
...
**Entregable.** 
- Hoja con los 3 puntos del equipo + contra-argumentos anticipados.
- Reflexión personal de 100 palabras independiente del bando.
