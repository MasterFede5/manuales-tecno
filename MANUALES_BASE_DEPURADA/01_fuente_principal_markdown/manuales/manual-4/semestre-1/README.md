# Semestre 1 — Manual 4: Inteligencia Artificial Avanzada

**Unidades de este semestre:** U01 (Prompts versionados), U02 (PRD del Asistente Institucional), U03 (Dashboards y Artifacts), U04 (RAG sobre reglamento), U05 (Automatización (n8n))
...
```bash
python build/converter.py manuales/manual-4 dist/manual-4-sem-1.html --semester 1
python print_to_pdf.py --manual 4 --semester 1
```
