...
- **Prompts versionados** conecta con la unidad final del semestre porque sienta las bases que ahí se aplican.
- **Automatización (n8n)** prepara el terreno para el próximo semestre o manual.
