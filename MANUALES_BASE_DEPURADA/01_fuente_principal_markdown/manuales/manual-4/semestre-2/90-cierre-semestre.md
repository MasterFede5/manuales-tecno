...
evidencias del case study **Asistente Institucional Albatros** producidas durante este
...
## Hacia el Semestre siguiente del Manual 5

::interioriza{titulo="Lo que viene"}
Cerraste el manual. El portafolio que produjiste te servirá como punto de partida para el siguiente manual de la serie Albatros, donde retomarás competencias y elevarás el reto.
