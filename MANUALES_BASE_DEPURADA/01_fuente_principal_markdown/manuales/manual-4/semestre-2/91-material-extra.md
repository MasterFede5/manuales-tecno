...
- **Agentes con herramientas** conecta con la unidad final del semestre porque sienta las bases que ahí se aplican.
- **Implementación, costos y gobernanza** prepara el terreno para el próximo semestre o manual.
...
- 🎓 **OCW** · n8n academy.
- 📺 **Video** · OpenAI platform docs.
- 📰 **Artículo** · Lectura breve sobre el case study **Asistente Institucional Albatros** (consulta con tu docente la referencia local).
...
Diseña una **infografía A3** que conecte las 5 unidades del semestre
en torno al case study **Asistente Institucional Albatros**. Debe incluir:
- El problema inicial.
- Una herramienta por unidad.
- La evidencia que producirá cada unidad.
- La conexión con el siguiente semestre.

Compártela con #AlbatrosManual4.
::/act-challenge

::act-mcq{titulo="Repaso transversal de opción múltiple"}
1. La función principal del case study **Asistente Institucional Albatros** en este manual es:
