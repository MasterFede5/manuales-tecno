...
paginas_ocupa: 0.5
fuente_md: manuales/manual-5/semestre-1/93-bibliografia-semestre.md
fuente_md_linea: 46
imagen_destino: assets/visuales/manual-5/sem1/M5-sem1-12.jpg
pagina_pdf_estimada: 307
...
**Tipo visual:** `cuadro-comparativo` · **Ocupa:** 0.5 pp · **Página PDF estimada:** 307
...
| Campo | Valor |
|---|---|
| ID estable | `M5-sem1-12` |
| Archivo destino imagen | `assets/visuales/manual-5/sem1/M5-sem1-12.jpg` |
| PDF en el que aparece | `dist/manual-5-sem-1.pdf` |
| Página PDF estimada | **p. 307** |
| Archivo Markdown fuente | `manuales/manual-5/semestre-1/93-bibliografia-semestre.md:46` |
...
2. Guárdala como `assets/visuales/manual-5/sem1/M5-sem1-12.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M5-sem1-12` ya no esté en estado `pendiente` corriendo:
