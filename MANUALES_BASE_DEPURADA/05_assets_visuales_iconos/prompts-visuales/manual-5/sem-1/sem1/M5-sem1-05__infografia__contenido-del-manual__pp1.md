...
tipo: infografia
paginas_ocupa: 1
fuente_md: manuales/manual-5/semestre-1/03-mapa-contenidos.md
fuente_md_linea: 17
imagen_destino: assets/visuales/manual-5/sem1/M5-sem1-05.jpg
...
| Campo | Valor |
|---|---|
| ID estable | `M5-sem1-05` |
| Archivo destino imagen | `assets/visuales/manual-5/sem1/M5-sem1-05.jpg` |
| PDF en el que aparece | `dist/manual-5-sem-1.pdf` |
| Página PDF estimada | **p. 11** |
| Archivo Markdown fuente | `manuales/manual-5/semestre-1/03-mapa-contenidos.md:17` |
...
2. Guárdala como `assets/visuales/manual-5/sem1/M5-sem1-05.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M5-sem1-05` ya no esté en estado `pendiente` corriendo:
