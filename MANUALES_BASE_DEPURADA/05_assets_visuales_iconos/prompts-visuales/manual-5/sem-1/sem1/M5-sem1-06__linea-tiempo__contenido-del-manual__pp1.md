...
tipo: linea-tiempo
paginas_ocupa: 1
fuente_md: manuales/manual-5/semestre-1/04-hilo-conductor.md
fuente_md_linea: 30
imagen_destino: assets/visuales/manual-5/sem1/M5-sem1-06.jpg
pagina_pdf_estimada: 15
...
**Tipo visual:** `linea-tiempo` · **Ocupa:** 1 pp · **Página PDF estimada:** 15
...
| Campo | Valor |
|---|---|
| ID estable | `M5-sem1-06` |
| Archivo destino imagen | `assets/visuales/manual-5/sem1/M5-sem1-06.jpg` |
| PDF en el que aparece | `dist/manual-5-sem-1.pdf` |
| Página PDF estimada | **p. 15** |
| Archivo Markdown fuente | `manuales/manual-5/semestre-1/04-hilo-conductor.md:30` |
...
2. Guárdala como `assets/visuales/manual-5/sem1/M5-sem1-06.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M5-sem1-06` ya no esté en estado `pendiente` corriendo:
