...
fuente_md_linea: 26
imagen_destino: assets/visuales/manual-5/sem1/M5-sem1-02.jpg
...
| Campo | Valor |
|---|---|
| ID estable | `M5-sem1-02` |
| Archivo destino imagen | `assets/visuales/manual-5/sem1/M5-sem1-02.jpg` |
| PDF en el que aparece | `dist/manual-5-sem-1.pdf` |
| Página PDF estimada | **p. 3** |
| Archivo Markdown fuente | `manuales/manual-5/semestre-1/00-portada.md:26` |
...
2. Guárdala como `assets/visuales/manual-5/sem1/M5-sem1-02.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M5-sem1-02` ya no esté en estado `pendiente` corriendo:
