...
paginas_ocupa: 1
fuente_md: manuales/manual-5/unidades/u08/10-tema-8-7.md
fuente_md_linea: 153
imagen_destino: assets/visuales/manual-5/u08/M5-u08-09.jpg
...
| Campo | Valor |
|---|---|
| ID estable | `M5-u08-09` |
| Archivo destino imagen | `assets/visuales/manual-5/u08/M5-u08-09.jpg` |
| PDF en el que aparece | `dist/manual-5-sem-2.pdf` |
| Página PDF estimada | **p. 253** |
| Archivo Markdown fuente | `manuales/manual-5/unidades/u08/10-tema-8-7.md:153` |
| Tipo de placeholder | `cuadro-comparativo` |
| Espacio reservado | 1 página(s) |

## Descripción original del manual

> Cuadro a tamaño página con 4 cuadrantes: Costo (caching, modelo, tokens), Errores (try, retry, fallback), Seguridad (keys, validación, rate limit), Monitoreo (logs, métricas, alertas). Cada cuadrante con código mínimo. Estilo blueprint educativo Albatros.
...
2. Guárdala como `assets/visuales/manual-5/u08/M5-u08-09.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M5-u08-09` ya no esté en estado `pendiente` corriendo:
