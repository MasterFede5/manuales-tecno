...
tipo: mapa-mental
paginas_ocupa: 1
fuente_md: manuales/manual-5/unidades/u08/01-mapa-mental.md
fuente_md_linea: 9
imagen_destino: assets/visuales/manual-5/u08/M5-u08-02.jpg
pagina_pdf_estimada: 219
...
**Tipo visual:** `mapa-mental` · **Ocupa:** 1 pp · **Página PDF estimada:** 219
...
| Campo | Valor |
|---|---|
| ID estable | `M5-u08-02` |
| Archivo destino imagen | `assets/visuales/manual-5/u08/M5-u08-02.jpg` |
| PDF en el que aparece | `dist/manual-5-sem-2.pdf` |
| Página PDF estimada | **p. 219** |
| Archivo Markdown fuente | `manuales/manual-5/unidades/u08/01-mapa-mental.md:9` |
| Tipo de placeholder | `mapa-mental` |
| Espacio reservado | 1 página(s) |

## Descripción original del manual

> Mapa mental con nodo central 'APIs de IA Generativa' y 7 ramas: 1) Configurar API. 2) Chatbot 30 líneas. 3) Streaming y tool use. 4) Embeddings + búsqueda. 5) Mini-RAG. 6) Streamlit. 7) Buenas prácticas (costo, errores, caching). Estilo blueprint.
...
2. Guárdala como `assets/visuales/manual-5/u08/M5-u08-02.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M5-u08-02` ya no esté en estado `pendiente` corriendo:
