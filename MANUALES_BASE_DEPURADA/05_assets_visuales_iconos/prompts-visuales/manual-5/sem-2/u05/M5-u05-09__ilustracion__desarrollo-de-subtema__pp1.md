...
tipo: ilustracion
paginas_ocupa: 1
fuente_md: manuales/manual-5/unidades/u05/10-tema-5-7.md
fuente_md_linea: 74
imagen_destino: assets/visuales/manual-5/u05/M5-u05-09.jpg
...
| Campo | Valor |
|---|---|
| ID estable | `M5-u05-09` |
| Archivo destino imagen | `assets/visuales/manual-5/u05/M5-u05-09.jpg` |
| PDF en el que aparece | `dist/manual-5-sem-2.pdf` |
| Página PDF estimada | **p. 54** |
| Archivo Markdown fuente | `manuales/manual-5/unidades/u05/10-tema-5-7.md:74` |
| Tipo de placeholder | `ilustracion` |
| Espacio reservado | 1 página(s) |

## Descripción original del manual

> Visualización a tamaño página de árbol de decisión real (max_depth=3). Nodos: raíz pregunta 'cal_anterior < 6.5?'. Ramas Sí/No con sub-preguntas (asistencia, horas). Hojas terminales con predicción promedio. Coloreado por clase predicha. A la derecha, importancia de features como bar chart. Estilo blueprint educativo Albatros.
...
2. Guárdala como `assets/visuales/manual-5/u05/M5-u05-09.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M5-u05-09` ya no esté en estado `pendiente` corriendo:
