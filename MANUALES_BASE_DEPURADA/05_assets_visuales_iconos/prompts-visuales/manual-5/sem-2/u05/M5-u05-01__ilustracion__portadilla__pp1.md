...
tipo: ilustracion
paginas_ocupa: 1
fuente_md: manuales/manual-5/unidades/u05/00-portadilla.md
fuente_md_linea: 13
imagen_destino: assets/visuales/manual-5/u05/M5-u05-01.jpg
...
| Campo | Valor |
|---|---|
| ID estable | `M5-u05-01` |
| Archivo destino imagen | `assets/visuales/manual-5/u05/M5-u05-01.jpg` |
| PDF en el que aparece | `dist/manual-5-sem-2.pdf` |
| Página PDF estimada | **p. 24** |
| Archivo Markdown fuente | `manuales/manual-5/unidades/u05/00-portadilla.md:13` |
| Tipo de placeholder | `ilustracion` |
| Espacio reservado | 1 página(s) |

## Descripción original del manual

> Ilustración hero U5: a la izquierda, datos históricos del alumno (horas, asistencia, cal_anterior). Flecha al centro: caja gris etiquetada 'Modelo ML' con engrane. A la derecha: predicción de cal_final con confianza. Bajo todo, scikit-learn logo. Mensaje: 'datos → modelo → predicción'. Paleta azul Albatros.
...
2. Guárdala como `assets/visuales/manual-5/u05/M5-u05-01.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M5-u05-01` ya no esté en estado `pendiente` corriendo:
