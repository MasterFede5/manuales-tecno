...
tipo: ilustracion
paginas_ocupa: 0.5
fuente_md: manuales/manual-5/semestre-2/01-carta-estudiante.md
fuente_md_linea: 39
imagen_destino: assets/visuales/manual-5/sem2/M5-sem2-03.jpg
...
| Campo | Valor |
|---|---|
| ID estable | `M5-sem2-03` |
| Archivo destino imagen | `assets/visuales/manual-5/sem2/M5-sem2-03.jpg` |
| PDF en el que aparece | `dist/manual-5-sem-2.pdf` |
| Página PDF estimada | **p. 6** |
| Archivo Markdown fuente | `manuales/manual-5/semestre-2/01-carta-estudiante.md:39` |
...
2. Guárdala como `assets/visuales/manual-5/sem2/M5-sem2-03.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M5-sem2-03` ya no esté en estado `pendiente` corriendo:
