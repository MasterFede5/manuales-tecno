...
tipo: grafica
paginas_ocupa: 0.5
fuente_md: manuales/manual-5/semestre-2/06-diagnostica.md
fuente_md_linea: 77
imagen_destino: assets/visuales/manual-5/sem2/M5-sem2-08.jpg
...
| Campo | Valor |
|---|---|
| ID estable | `M5-sem2-08` |
| Archivo destino imagen | `assets/visuales/manual-5/sem2/M5-sem2-08.jpg` |
| PDF en el que aparece | `dist/manual-5-sem-2.pdf` |
| Página PDF estimada | **p. 23** |
| Archivo Markdown fuente | `manuales/manual-5/semestre-2/06-diagnostica.md:77` |
...
2. Guárdala como `assets/visuales/manual-5/sem2/M5-sem2-08.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M5-sem2-08` ya no esté en estado `pendiente` corriendo:
