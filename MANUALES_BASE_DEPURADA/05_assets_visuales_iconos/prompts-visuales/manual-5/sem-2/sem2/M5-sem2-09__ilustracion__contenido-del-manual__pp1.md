...
tipo: ilustracion
paginas_ocupa: 1
fuente_md: manuales/manual-5/semestre-2/90-cierre-semestre.md
fuente_md_linea: 57
imagen_destino: assets/visuales/manual-5/sem2/M5-sem2-09.jpg
pagina_pdf_estimada: 284
...
**Tipo visual:** `ilustracion` · **Ocupa:** 1 pp · **Página PDF estimada:** 284
...
| Campo | Valor |
|---|---|
| ID estable | `M5-sem2-09` |
| Archivo destino imagen | `assets/visuales/manual-5/sem2/M5-sem2-09.jpg` |
| PDF en el que aparece | `dist/manual-5-sem-2.pdf` |
| Página PDF estimada | **p. 284** |
| Archivo Markdown fuente | `manuales/manual-5/semestre-2/90-cierre-semestre.md:57` |
...
2. Guárdala como `assets/visuales/manual-5/sem2/M5-sem2-09.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M5-sem2-09` ya no esté en estado `pendiente` corriendo:
