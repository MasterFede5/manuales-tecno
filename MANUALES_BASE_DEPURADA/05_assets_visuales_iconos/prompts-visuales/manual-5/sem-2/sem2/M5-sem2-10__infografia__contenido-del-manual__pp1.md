...
tipo: infografia
paginas_ocupa: 1
fuente_md: manuales/manual-5/semestre-2/91-material-extra.md
fuente_md_linea: 91
imagen_destino: assets/visuales/manual-5/sem2/M5-sem2-10.jpg
pagina_pdf_estimada: 290
...
**Tipo visual:** `infografia` · **Ocupa:** 1 pp · **Página PDF estimada:** 290
...
| Campo | Valor |
|---|---|
| ID estable | `M5-sem2-10` |
| Archivo destino imagen | `assets/visuales/manual-5/sem2/M5-sem2-10.jpg` |
| PDF en el que aparece | `dist/manual-5-sem-2.pdf` |
| Página PDF estimada | **p. 290** |
| Archivo Markdown fuente | `manuales/manual-5/semestre-2/91-material-extra.md:91` |
...
2. Guárdala como `assets/visuales/manual-5/sem2/M5-sem2-10.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M5-sem2-10` ya no esté en estado `pendiente` corriendo:
