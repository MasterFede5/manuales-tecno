...
paginas_ocupa: 1
fuente_md: manuales/manual-5/semestre-2/05-competencias.md
fuente_md_linea: 37
imagen_destino: assets/visuales/manual-5/sem2/M5-sem2-07.jpg
...
**Tipo visual:** `cuadro-comparativo` · **Ocupa:** 1 pp · **Página PDF estimada:** 18
...
| Campo | Valor |
|---|---|
| ID estable | `M5-sem2-07` |
| Archivo destino imagen | `assets/visuales/manual-5/sem2/M5-sem2-07.jpg` |
| PDF en el que aparece | `dist/manual-5-sem-2.pdf` |
| Página PDF estimada | **p. 18** |
| Archivo Markdown fuente | `manuales/manual-5/semestre-2/05-competencias.md:37` |
...
2. Guárdala como `assets/visuales/manual-5/sem2/M5-sem2-07.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M5-sem2-07` ya no esté en estado `pendiente` corriendo:
