...
tipo: linea-tiempo
paginas_ocupa: 1
fuente_md: manuales/manual-5/semestre-2/04-hilo-conductor.md
fuente_md_linea: 30
imagen_destino: assets/visuales/manual-5/sem2/M5-sem2-06.jpg
...
2. Guárdala como `assets/visuales/manual-5/sem2/M5-sem2-06.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M5-sem2-06` ya no esté en estado `pendiente` corriendo:
