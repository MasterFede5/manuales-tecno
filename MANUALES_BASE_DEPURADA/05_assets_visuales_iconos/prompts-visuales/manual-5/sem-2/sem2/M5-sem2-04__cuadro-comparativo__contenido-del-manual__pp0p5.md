...
paginas_ocupa: 0.5
fuente_md: manuales/manual-5/semestre-2/02-carta-docente.md
fuente_md_linea: 56
imagen_destino: assets/visuales/manual-5/sem2/M5-sem2-04.jpg
...
| Campo | Valor |
|---|---|
| ID estable | `M5-sem2-04` |
| Archivo destino imagen | `assets/visuales/manual-5/sem2/M5-sem2-04.jpg` |
| PDF en el que aparece | `dist/manual-5-sem-2.pdf` |
| Página PDF estimada | **p. 9** |
| Archivo Markdown fuente | `manuales/manual-5/semestre-2/02-carta-docente.md:56` |
...
2. Guárdala como `assets/visuales/manual-5/sem2/M5-sem2-04.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M5-sem2-04` ya no esté en estado `pendiente` corriendo:
