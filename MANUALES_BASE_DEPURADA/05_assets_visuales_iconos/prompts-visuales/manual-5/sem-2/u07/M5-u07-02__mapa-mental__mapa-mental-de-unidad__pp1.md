...
tipo: mapa-mental
paginas_ocupa: 1
fuente_md: manuales/manual-5/unidades/u07/01-mapa-mental.md
fuente_md_linea: 9
imagen_destino: assets/visuales/manual-5/u07/M5-u07-02.jpg
...
**Tipo visual:** `mapa-mental` · **Ocupa:** 1 pp · **Página PDF estimada:** 156
...
| Campo | Valor |
|---|---|
| ID estable | `M5-u07-02` |
| Archivo destino imagen | `assets/visuales/manual-5/u07/M5-u07-02.jpg` |
| PDF en el que aparece | `dist/manual-5-sem-2.pdf` |
| Página PDF estimada | **p. 156** |
| Archivo Markdown fuente | `manuales/manual-5/unidades/u07/01-mapa-mental.md:9` |
| Tipo de placeholder | `mapa-mental` |
| Espacio reservado | 1 página(s) |

## Descripción original del manual

> Mapa mental con nodo central 'Redes Neuronales' y 6 ramas: 1) Neurona artificial. 2) Capas y activaciones. 3) Forward + backprop. 4) PyTorch (tensors, nn.Module, optimizer). 5) MLP entrenado. 6) Curva de aprendizaje. Estilo blueprint.
...
2. Guárdala como `assets/visuales/manual-5/u07/M5-u07-02.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M5-u07-02` ya no esté en estado `pendiente` corriendo:
