...
tipo: ilustracion
paginas_ocupa: 1
fuente_md: manuales/manual-3/unidades/u02/00-portadilla.md
fuente_md_linea: 13
imagen_destino: assets/visuales/manual-3/u02/M3-u02-01.jpg
...
| Campo | Valor |
|---|---|
| ID estable | `M3-u02-01` |
| Archivo destino imagen | `assets/visuales/manual-3/u02/M3-u02-01.jpg` |
| PDF en el que aparece | `dist/manual-3-sem-1.pdf` |
| Página PDF estimada | **p. 67** |
| Archivo Markdown fuente | `manuales/manual-3/unidades/u02/00-portadilla.md:13` |
| Tipo de placeholder | `ilustracion` |
| Espacio reservado | 1 página(s) |

## Descripción original del manual

> Ilustración hero con tres pestañas de navegador abiertas en paralelo: ChatGPT (logo de OpenAI), Claude (logo de Anthropic), Gemini (logo de Google). Una persona estudia frente a una laptop con las tres ventanas visibles. Burbujas de chat saliendo de cada plataforma con respuestas distintas a la misma pregunta. Estudiante toma notas comparando.
...
2. Guárdala como `assets/visuales/manual-3/u02/M3-u02-01.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M3-u02-01` ya no esté en estado `pendiente` corriendo:
