...
fuente_md_linea: 67
imagen_destino: assets/visuales/manual-3/u02/M3-u02-10.jpg
...
| Campo | Valor |
|---|---|
| ID estable | `M3-u02-10` |
| Archivo destino imagen | `assets/visuales/manual-3/u02/M3-u02-10.jpg` |
| PDF en el que aparece | `dist/manual-3-sem-1.pdf` |
| Página PDF estimada | **p. 88** |
| Archivo Markdown fuente | `manuales/manual-3/unidades/u02/10-tema-2-6.md:67` |
| Tipo de placeholder | `ilustracion` |
| Espacio reservado | 0.5 página(s) |

## Descripción original del manual

> Diagrama de árbol de decisión visual: nodo raíz '¿Qué necesitas hacer?' con 5 ramas hacia hojas: a) Redactar largo → Claude Opus icono. b) Multimodal/voz/plugins → ChatGPT icono. c) Vives en Google → Gemini icono. d) Vives en Microsoft → Copilot icono. e) Privacidad/autohospedaje → Llama icono. Cada hoja con precio y descripción de una línea. Líneas conectoras coloreadas según ecosistema.
...
2. Guárdala como `assets/visuales/manual-3/u02/M3-u02-10.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M3-u02-10` ya no esté en estado `pendiente` corriendo:
