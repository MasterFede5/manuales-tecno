...
tipo: infografia
paginas_ocupa: 1
fuente_md: manuales/manual-3/semestre-1/03-mapa-contenidos.md
fuente_md_linea: 18
imagen_destino: assets/visuales/manual-3/sem1/M3-sem1-05.jpg
...
| Campo | Valor |
|---|---|
| ID estable | `M3-sem1-05` |
| Archivo destino imagen | `assets/visuales/manual-3/sem1/M3-sem1-05.jpg` |
| PDF en el que aparece | `dist/manual-3-sem-1.pdf` |
| Página PDF estimada | **p. 7** |
| Archivo Markdown fuente | `manuales/manual-3/semestre-1/03-mapa-contenidos.md:18` |
...
2. Guárdala como `assets/visuales/manual-3/sem1/M3-sem1-05.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M3-sem1-05` ya no esté en estado `pendiente` corriendo:
