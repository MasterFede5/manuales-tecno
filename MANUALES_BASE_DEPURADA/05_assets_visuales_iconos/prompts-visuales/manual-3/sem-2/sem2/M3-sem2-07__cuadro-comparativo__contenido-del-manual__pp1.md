...
paginas_ocupa: 1
fuente_md: manuales/manual-3/semestre-2/05-competencias.md
fuente_md_linea: 37
imagen_destino: assets/visuales/manual-3/sem2/M3-sem2-07.jpg
...
| Campo | Valor |
|---|---|
| ID estable | `M3-sem2-07` |
| Archivo destino imagen | `assets/visuales/manual-3/sem2/M3-sem2-07.jpg` |
| PDF en el que aparece | `dist/manual-3-sem-2.pdf` |
| Página PDF estimada | **p. 12** |
| Archivo Markdown fuente | `manuales/manual-3/semestre-2/05-competencias.md:37` |
...
2. Guárdala como `assets/visuales/manual-3/sem2/M3-sem2-07.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M3-sem2-07` ya no esté en estado `pendiente` corriendo:
