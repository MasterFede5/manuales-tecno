...
tipo: linea-tiempo
paginas_ocupa: 1
fuente_md: manuales/manual-3/semestre-2/04-hilo-conductor.md
fuente_md_linea: 30
imagen_destino: assets/visuales/manual-3/sem2/M3-sem2-06.jpg
...
**Tipo visual:** `linea-tiempo` · **Ocupa:** 1 pp · **Página PDF estimada:** 10
...
| Campo | Valor |
|---|---|
| ID estable | `M3-sem2-06` |
| Archivo destino imagen | `assets/visuales/manual-3/sem2/M3-sem2-06.jpg` |
| PDF en el que aparece | `dist/manual-3-sem-2.pdf` |
| Página PDF estimada | **p. 10** |
| Archivo Markdown fuente | `manuales/manual-3/semestre-2/04-hilo-conductor.md:30` |
| Tipo de placeholder | `linea-tiempo` |
| Espacio reservado | 1 página(s) |

## Descripción original del manual

> Línea de tiempo horizontal del semestre 2: en el extremo izquierdo, el problema inicial del case study 'Mi tutor IA personal'; en el centro, 4 hitos correspondientes a los episodios de cada unidad (u06, u07, u08, u09); en el extremo derecho, el entregable final del portafolio del semestre. Cada hito con fecha tentativa (semana N), título corto y micro-ilustración temática.  
...
2. Guárdala como `assets/visuales/manual-3/sem2/M3-sem2-06.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M3-sem2-06` ya no esté en estado `pendiente` corriendo:
