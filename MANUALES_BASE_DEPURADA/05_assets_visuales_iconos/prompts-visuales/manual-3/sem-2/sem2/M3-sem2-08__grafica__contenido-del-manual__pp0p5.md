...
tipo: grafica
paginas_ocupa: 0.5
fuente_md: manuales/manual-3/semestre-2/06-diagnostica.md
fuente_md_linea: 77
imagen_destino: assets/visuales/manual-3/sem2/M3-sem2-08.jpg
...
**Tipo visual:** `grafica` · **Ocupa:** 0.5 pp · **Página PDF estimada:** 15
...
| Campo | Valor |
|---|---|
| ID estable | `M3-sem2-08` |
| Archivo destino imagen | `assets/visuales/manual-3/sem2/M3-sem2-08.jpg` |
| PDF en el que aparece | `dist/manual-3-sem-2.pdf` |
| Página PDF estimada | **p. 15** |
| Archivo Markdown fuente | `manuales/manual-3/semestre-2/06-diagnostica.md:77` |
...
2. Guárdala como `assets/visuales/manual-3/sem2/M3-sem2-08.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M3-sem2-08` ya no esté en estado `pendiente` corriendo:
