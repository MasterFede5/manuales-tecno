...
paginas_ocupa: 0.5
fuente_md: manuales/manual-3/semestre-2/93-bibliografia-semestre.md
fuente_md_linea: 47
imagen_destino: assets/visuales/manual-3/sem2/M3-sem2-12.jpg
pagina_pdf_estimada: 254
...
**Tipo visual:** `cuadro-comparativo` · **Ocupa:** 0.5 pp · **Página PDF estimada:** 254
...
| Campo | Valor |
|---|---|
| ID estable | `M3-sem2-12` |
| Archivo destino imagen | `assets/visuales/manual-3/sem2/M3-sem2-12.jpg` |
| PDF en el que aparece | `dist/manual-3-sem-2.pdf` |
| Página PDF estimada | **p. 254** |
| Archivo Markdown fuente | `manuales/manual-3/semestre-2/93-bibliografia-semestre.md:47` |
...
2. Guárdala como `assets/visuales/manual-3/sem2/M3-sem2-12.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M3-sem2-12` ya no esté en estado `pendiente` corriendo:
