...
tipo: infografia
paginas_ocupa: 1
fuente_md: manuales/manual-3/semestre-2/91-material-extra.md
fuente_md_linea: 91
imagen_destino: assets/visuales/manual-3/sem2/M3-sem2-10.jpg
...
**Tipo visual:** `infografia` · **Ocupa:** 1 pp · **Página PDF estimada:** 249
...
| Campo | Valor |
|---|---|
| ID estable | `M3-sem2-10` |
| Archivo destino imagen | `assets/visuales/manual-3/sem2/M3-sem2-10.jpg` |
| PDF en el que aparece | `dist/manual-3-sem-2.pdf` |
| Página PDF estimada | **p. 249** |
| Archivo Markdown fuente | `manuales/manual-3/semestre-2/91-material-extra.md:91` |
| Tipo de placeholder | `infografia` |
| Espacio reservado | 1 página(s) |

## Descripción original del manual

> Infografía resumen del semestre completo en una sola hoja: panel superior con el case study, panel medio con las 4 unidades del semestre como columnas (cada columna con título, ícono y entregable), panel inferior con los 3 hábitos de estudio Albatros y el portafolio final. Paleta azul Albatros + naranja, listo para colgar en el cuaderno.  
...
2. Guárdala como `assets/visuales/manual-3/sem2/M3-sem2-10.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M3-sem2-10` ya no esté en estado `pendiente` corriendo:
