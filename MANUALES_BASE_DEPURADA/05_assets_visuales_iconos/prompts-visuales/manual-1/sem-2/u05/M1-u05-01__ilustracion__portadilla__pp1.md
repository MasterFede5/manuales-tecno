...
tipo: ilustracion
paginas_ocupa: 1
fuente_md: manuales/manual-1/unidades/u05/00-portadilla.md
fuente_md_linea: 13
imagen_destino: assets/visuales/manual-1/u05/M1-u05-01.jpg
...
| Campo | Valor |
|---|---|
| ID estable | `M1-u05-01` |
| Archivo destino imagen | `assets/visuales/manual-1/u05/M1-u05-01.jpg` |
| PDF en el que aparece | `dist/manual-1-sem-2.pdf` |
| Página PDF estimada | **p. 67** |
| Archivo Markdown fuente | `manuales/manual-1/unidades/u05/00-portadilla.md:13` |
| Tipo de placeholder | `ilustracion` |
| Espacio reservado | 1 página(s) |

## Descripción original del manual

> Ilustración hero mostrando una reacción química representada como balance contable: a un lado moles de reactivos con su valor energético, al otro lado moles de productos con su nuevo valor energético, y una flecha que muestra la diferencia liberada o absorbida como calor. Fondo con elementos visuales de química verde (gotas de agua, hojas, símbolos de reciclaje).
...
2. Guárdala como `assets/visuales/manual-1/u05/M1-u05-01.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M1-u05-01` ya no esté en estado `pendiente` corriendo:
