...
tipo: grafica
paginas_ocupa: 0.5
fuente_md: manuales/manual-1/unidades/u05/93-taller.md
fuente_md_linea: 35
imagen_destino: assets/visuales/manual-1/u05/M1-u05-11.jpg
...
**Tipo visual:** `grafica` · **Ocupa:** 0.5 pp · **Página PDF estimada:** 134
...
| Campo | Valor |
|---|---|
| ID estable | `M1-u05-11` |
| Archivo destino imagen | `assets/visuales/manual-1/u05/M1-u05-11.jpg` |
| PDF en el que aparece | `dist/manual-1-sem-2.pdf` |
| Página PDF estimada | **p. 134** |
| Archivo Markdown fuente | `manuales/manual-1/unidades/u05/93-taller.md:35` |
| Tipo de placeholder | `grafica` |
| Espacio reservado | 0.5 página(s) |

## Descripción original del manual

> Gráfica de velocidad de descomposición de H2O2 (eje Y, mL O2/min) vs temperatura (eje X, 5-50 grados C) con tres curvas: sin catalizador, con MnO2, con catalasa. Muestra tendencia exponencial y comparación de pendientes para discutir energía de activación.
...
2. Guárdala como `assets/visuales/manual-1/u05/M1-u05-11.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M1-u05-11` ya no esté en estado `pendiente` corriendo:
