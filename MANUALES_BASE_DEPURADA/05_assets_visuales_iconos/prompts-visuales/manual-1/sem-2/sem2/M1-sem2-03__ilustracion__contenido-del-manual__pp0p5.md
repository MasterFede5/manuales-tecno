...
tipo: ilustracion
paginas_ocupa: 0.5
fuente_md: manuales/manual-1/semestre-2/01-carta-estudiante.md
fuente_md_linea: 39
imagen_destino: assets/visuales/manual-1/sem2/M1-sem2-03.jpg
pagina_pdf_estimada: 3
...
**Tipo visual:** `ilustracion` · **Ocupa:** 0.5 pp · **Página PDF estimada:** 3
...
| Campo | Valor |
|---|---|
| ID estable | `M1-sem2-03` |
| Archivo destino imagen | `assets/visuales/manual-1/sem2/M1-sem2-03.jpg` |
| PDF en el que aparece | `dist/manual-1-sem-2.pdf` |
| Página PDF estimada | **p. 3** |
| Archivo Markdown fuente | `manuales/manual-1/semestre-2/01-carta-estudiante.md:39` |
...
2. Guárdala como `assets/visuales/manual-1/sem2/M1-sem2-03.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M1-sem2-03` ya no esté en estado `pendiente` corriendo:
