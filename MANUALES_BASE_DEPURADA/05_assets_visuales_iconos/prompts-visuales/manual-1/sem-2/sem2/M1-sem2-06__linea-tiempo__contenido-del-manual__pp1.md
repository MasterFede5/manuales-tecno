...
tipo: linea-tiempo
paginas_ocupa: 1
fuente_md: manuales/manual-1/semestre-2/04-hilo-conductor.md
fuente_md_linea: 29
imagen_destino: assets/visuales/manual-1/sem2/M1-sem2-06.jpg
...
| Campo | Valor |
|---|---|
| ID estable | `M1-sem2-06` |
| Archivo destino imagen | `assets/visuales/manual-1/sem2/M1-sem2-06.jpg` |
| PDF en el que aparece | `dist/manual-1-sem-2.pdf` |
| Página PDF estimada | **p. 8** |
| Archivo Markdown fuente | `manuales/manual-1/semestre-2/04-hilo-conductor.md:29` |
| Tipo de placeholder | `linea-tiempo` |
| Espacio reservado | 1 página(s) |

## Descripción original del manual

> Línea de tiempo horizontal del semestre 2: en el extremo izquierdo, el problema inicial del case study 'Agua escolar saludable'; en el centro, 3 hitos correspondientes a los episodios de cada unidad (u04, u05, u06); en el extremo derecho, el entregable final del portafolio del semestre. Cada hito con fecha tentativa (semana N), título corto y micro-ilustración temática.  
...
2. Guárdala como `assets/visuales/manual-1/sem2/M1-sem2-06.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M1-sem2-06` ya no esté en estado `pendiente` corriendo:
