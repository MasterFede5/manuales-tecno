...
fuente_md_linea: 26
imagen_destino: assets/visuales/manual-1/sem2/M1-sem2-02.jpg
...
**Tipo visual:** `ilustracion` · **Ocupa:** 0.5 pp · **Página PDF estimada:** 1
...
| Campo | Valor |
|---|---|
| ID estable | `M1-sem2-02` |
| Archivo destino imagen | `assets/visuales/manual-1/sem2/M1-sem2-02.jpg` |
| PDF en el que aparece | `dist/manual-1-sem-2.pdf` |
| Página PDF estimada | **p. 1** |
| Archivo Markdown fuente | `manuales/manual-1/semestre-2/00-portada.md:26` |
...
2. Guárdala como `assets/visuales/manual-1/sem2/M1-sem2-02.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M1-sem2-02` ya no esté en estado `pendiente` corriendo:
