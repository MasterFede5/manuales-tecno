...
tipo: infografia
paginas_ocupa: 1
fuente_md: manuales/manual-1/semestre-2/03-mapa-contenidos.md
fuente_md_linea: 16
imagen_destino: assets/visuales/manual-1/sem2/M1-sem2-05.jpg
...
| Campo | Valor |
|---|---|
| ID estable | `M1-sem2-05` |
| Archivo destino imagen | `assets/visuales/manual-1/sem2/M1-sem2-05.jpg` |
| PDF en el que aparece | `dist/manual-1-sem-2.pdf` |
| Página PDF estimada | **p. 6** |
| Archivo Markdown fuente | `manuales/manual-1/semestre-2/03-mapa-contenidos.md:16` |
| Tipo de placeholder | `infografia` |
| Espacio reservado | 1 página(s) |

## Descripción original del manual

> Infografía vertical tipo mapa visual del semestre 2 del manual Química Albatros: en la parte superior, el título del case study 'Agua escolar saludable'. Debajo, una columna de 3 estaciones conectadas verticalmente, una por unidad (u04, u05, u06), cada estación con su número, título, ícono temático y la herramienta que aporta al caso. Al pie, un entregable de portafolio final del semestre. Paleta azul Albatros + naranja en conectores.  
...
2. Guárdala como `assets/visuales/manual-1/sem2/M1-sem2-05.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M1-sem2-05` ya no esté en estado `pendiente` corriendo:
