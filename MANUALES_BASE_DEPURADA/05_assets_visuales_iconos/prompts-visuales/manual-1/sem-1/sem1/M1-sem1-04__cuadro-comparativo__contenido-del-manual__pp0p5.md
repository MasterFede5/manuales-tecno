...
paginas_ocupa: 0.5
fuente_md: manuales/manual-1/semestre-1/02-carta-docente.md
fuente_md_linea: 56
imagen_destino: assets/visuales/manual-1/sem1/M1-sem1-04.jpg
...
| Campo | Valor |
|---|---|
| ID estable | `M1-sem1-04` |
| Archivo destino imagen | `assets/visuales/manual-1/sem1/M1-sem1-04.jpg` |
| PDF en el que aparece | `dist/manual-1-sem-1.pdf` |
| Página PDF estimada | **p. 5** |
| Archivo Markdown fuente | `manuales/manual-1/semestre-1/02-carta-docente.md:56` |
...
2. Guárdala como `assets/visuales/manual-1/sem1/M1-sem1-04.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M1-sem1-04` ya no esté en estado `pendiente` corriendo:
