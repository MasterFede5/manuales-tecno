...
paginas_ocupa: 1
fuente_md: manuales/manual-1/semestre-1/05-competencias.md
fuente_md_linea: 37
imagen_destino: assets/visuales/manual-1/sem1/M1-sem1-07.jpg
...
| Campo | Valor |
|---|---|
| ID estable | `M1-sem1-07` |
| Archivo destino imagen | `assets/visuales/manual-1/sem1/M1-sem1-07.jpg` |
| PDF en el que aparece | `dist/manual-1-sem-1.pdf` |
| Página PDF estimada | **p. 10** |
| Archivo Markdown fuente | `manuales/manual-1/semestre-1/05-competencias.md:37` |
...
2. Guárdala como `assets/visuales/manual-1/sem1/M1-sem1-07.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M1-sem1-07` ya no esté en estado `pendiente` corriendo:
