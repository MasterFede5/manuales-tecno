...
tipo: infografia
paginas_ocupa: 1
fuente_md: manuales/manual-1/semestre-1/91-material-extra.md
fuente_md_linea: 91
imagen_destino: assets/visuales/manual-1/sem1/M1-sem1-10.jpg
...
**Tipo visual:** `infografia` · **Ocupa:** 1 pp · **Página PDF estimada:** 253
...
| Campo | Valor |
|---|---|
| ID estable | `M1-sem1-10` |
| Archivo destino imagen | `assets/visuales/manual-1/sem1/M1-sem1-10.jpg` |
| PDF en el que aparece | `dist/manual-1-sem-1.pdf` |
| Página PDF estimada | **p. 253** |
| Archivo Markdown fuente | `manuales/manual-1/semestre-1/91-material-extra.md:91` |
...
2. Guárdala como `assets/visuales/manual-1/sem1/M1-sem1-10.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M1-sem1-10` ya no esté en estado `pendiente` corriendo:
