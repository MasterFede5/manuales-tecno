...
fuente_md_linea: 121
imagen_destino: assets/visuales/manual-1/u01/M1-u01-08.jpg
...
**Tipo visual:** `ilustracion` · **Ocupa:** 0.5 pp · **Página PDF estimada:** 84
...
| Campo | Valor |
|---|---|
| ID estable | `M1-u01-08` |
| Archivo destino imagen | `assets/visuales/manual-1/u01/M1-u01-08.jpg` |
| PDF en el que aparece | `dist/manual-1-sem-1.pdf` |
| Página PDF estimada | **p. 84** |
| Archivo Markdown fuente | `manuales/manual-1/unidades/u01/10-tema-1-4.md:121` |
| Tipo de placeholder | `ilustracion` |
| Espacio reservado | 0.5 página(s) |

## Descripción original del manual

> Galería de símbolos de Lewis para 10 elementos representativos: H, He, C, N, O, F, Na, Mg, Al, Cl. Cada símbolo del elemento centrado, rodeado por puntos negros que representan los electrones de valencia, con la disposición correcta (un punto por lado antes de aparear). Cada uno con su número de grupo.
...
2. Guárdala como `assets/visuales/manual-1/u01/M1-u01-08.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M1-u01-08` ya no esté en estado `pendiente` corriendo:
