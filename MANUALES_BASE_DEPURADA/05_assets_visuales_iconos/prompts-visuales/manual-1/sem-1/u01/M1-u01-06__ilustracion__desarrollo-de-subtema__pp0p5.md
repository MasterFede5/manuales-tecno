...
tipo: ilustracion
paginas_ocupa: 0.5
fuente_md: manuales/manual-1/unidades/u01/10-tema-1-3.md
fuente_md_linea: 59
imagen_destino: assets/visuales/manual-1/u01/M1-u01-06.jpg
...
**Tipo visual:** `ilustracion` · **Ocupa:** 0.5 pp · **Página PDF estimada:** 80
...
| Campo | Valor |
|---|---|
| ID estable | `M1-u01-06` |
| Archivo destino imagen | `assets/visuales/manual-1/u01/M1-u01-06.jpg` |
| PDF en el que aparece | `dist/manual-1-sem-1.pdf` |
| Página PDF estimada | **p. 80** |
| Archivo Markdown fuente | `manuales/manual-1/unidades/u01/10-tema-1-3.md:59` |
| Tipo de placeholder | `ilustracion` |
| Espacio reservado | 0.5 página(s) |

## Descripción original del manual

> Diagrama de Moeller (regla de las diagonales) que muestra el orden de llenado de orbitales con flechas diagonales descendentes: 1s, 2s, 2p, 3s, 3p, 4s, 3d, 4p, 5s, 4d, 5p, 6s, 4f, 5d, 6p, 7s. Junto a cada subnivel, su capacidad máxima de electrones.
...
2. Guárdala como `assets/visuales/manual-1/u01/M1-u01-06.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M1-u01-06` ya no esté en estado `pendiente` corriendo:
