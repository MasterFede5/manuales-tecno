...
fuente_md_linea: 66
imagen_destino: assets/visuales/manual-1/u01/M1-u01-03.jpg
...
**Tipo visual:** `cuadro-comparativo` · **Ocupa:** 0.5 pp · **Página PDF estimada:** 72
...
| Campo | Valor |
|---|---|
| ID estable | `M1-u01-03` |
| Archivo destino imagen | `assets/visuales/manual-1/u01/M1-u01-03.jpg` |
| PDF en el que aparece | `dist/manual-1-sem-1.pdf` |
| Página PDF estimada | **p. 72** |
| Archivo Markdown fuente | `manuales/manual-1/unidades/u01/10-tema-1-1.md:66` |
| Tipo de placeholder | `cuadro-comparativo` |
| Espacio reservado | 0.5 página(s) |

## Descripción original del manual

> Cuadro comparativo de doble entrada que muestra ejemplos cotidianos clasificados como sustancia pura (elemento, compuesto) o mezcla (homogénea, heterogénea), con columnas para composición, ejemplo concreto y método de separación cuando aplica.
...
2. Guárdala como `assets/visuales/manual-1/u01/M1-u01-03.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M1-u01-03` ya no esté en estado `pendiente` corriendo:
