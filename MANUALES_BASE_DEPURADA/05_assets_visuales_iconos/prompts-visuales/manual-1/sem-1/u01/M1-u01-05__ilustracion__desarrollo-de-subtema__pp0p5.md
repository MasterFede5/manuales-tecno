...
fuente_md_linea: 84
imagen_destino: assets/visuales/manual-1/u01/M1-u01-05.jpg
...
**Tipo visual:** `ilustracion` · **Ocupa:** 0.5 pp · **Página PDF estimada:** 76
...
| Campo | Valor |
|---|---|
| ID estable | `M1-u01-05` |
| Archivo destino imagen | `assets/visuales/manual-1/u01/M1-u01-05.jpg` |
| PDF en el que aparece | `dist/manual-1-sem-1.pdf` |
| Página PDF estimada | **p. 76** |
| Archivo Markdown fuente | `manuales/manual-1/unidades/u01/10-tema-1-2.md:84` |
| Tipo de placeholder | `ilustracion` |
| Espacio reservado | 0.5 página(s) |

## Descripción original del manual

> Diagrama de tres átomos lado a lado mostrando los isótopos del hidrógeno: protio (1p, 0n), deuterio (1p, 1n) y tritio (1p, 2n). Cada uno con su electrón orbitando, su masa atómica y un ejemplo de aplicación (agua común, agua pesada en reactores nucleares, marcador en biología molecular).
...
2. Guárdala como `assets/visuales/manual-1/u01/M1-u01-05.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M1-u01-05` ya no esté en estado `pendiente` corriendo:
