...
tipo: mapa-mental
paginas_ocupa: 1
fuente_md: manuales/manual-2/unidades/u03/01-mapa-mental.md
fuente_md_linea: 9
imagen_destino: assets/visuales/manual-2/u03/M2-u03-02.jpg
...
**Tipo visual:** `mapa-mental` · **Ocupa:** 1 pp · **Página PDF estimada:** 139
...
| Campo | Valor |
|---|---|
| ID estable | `M2-u03-02` |
| Archivo destino imagen | `assets/visuales/manual-2/u03/M2-u03-02.jpg` |
| PDF en el que aparece | `dist/manual-2-sem-1.pdf` |
| Página PDF estimada | **p. 139** |
| Archivo Markdown fuente | `manuales/manual-2/unidades/u03/01-mapa-mental.md:9` |
| Tipo de placeholder | `mapa-mental` |
| Espacio reservado | 1 página(s) |

## Descripción original del manual

> Mapa mental con nodo central TRABAJO Y ENERGÍA y ocho ramas: 1) TRABAJO (W = F·d cos θ); 2) POTENCIA (P = W/t); 3) E. CINÉTICA (Ek = ½mv²); 4) E. POTENCIAL (Ug = mgh, Ue = ½kx²); 5) CONSERVACIÓN (Em inicial = Em final + W_disipado); 6) IMPETU (p = mv); 7) COLISIONES (elásticas, inelásticas, conservación de p); 8) DISIPATIVOS (fricción, calor).
...
2. Guárdala como `assets/visuales/manual-2/u03/M2-u03-02.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M2-u03-02` ya no esté en estado `pendiente` corriendo:
