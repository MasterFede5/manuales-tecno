...
tipo: ilustracion
paginas_ocupa: 1
fuente_md: manuales/manual-2/unidades/u03/00-portadilla.md
fuente_md_linea: 13
imagen_destino: assets/visuales/manual-2/u03/M2-u03-01.jpg
...
| Campo | Valor |
|---|---|
| ID estable | `M2-u03-01` |
| Archivo destino imagen | `assets/visuales/manual-2/u03/M2-u03-01.jpg` |
| PDF en el que aparece | `dist/manual-2-sem-1.pdf` |
| Página PDF estimada | **p. 139** |
| Archivo Markdown fuente | `manuales/manual-2/unidades/u03/00-portadilla.md:13` |
| Tipo de placeholder | `ilustracion` |
| Espacio reservado | 1 página(s) |

## Descripción original del manual

> Ilustración hero mostrando la transformación de energía en el coche F1: cartucho CO2 con energía química, transferencia a energía cinética del coche en movimiento, fricción transformándose en calor (representado con ondas térmicas saliendo de las llantas y la pista), y al final pequeñas manchas de energía 'perdida' en forma de calor irrecuperable. Paleta azul-naranja con efectos térmicos.
...
2. Guárdala como `assets/visuales/manual-2/u03/M2-u03-01.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M2-u03-01` ya no esté en estado `pendiente` corriendo:
