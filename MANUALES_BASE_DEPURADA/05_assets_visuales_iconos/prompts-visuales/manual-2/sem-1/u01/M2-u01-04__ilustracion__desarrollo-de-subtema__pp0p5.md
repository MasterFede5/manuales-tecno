...
tipo: ilustracion
paginas_ocupa: 0.5
fuente_md: manuales/manual-2/unidades/u01/10-tema-1-2.md
fuente_md_linea: 87
imagen_destino: assets/visuales/manual-2/u01/M2-u01-04.jpg
...
| Campo | Valor |
|---|---|
| ID estable | `M2-u01-04` |
| Archivo destino imagen | `assets/visuales/manual-2/u01/M2-u01-04.jpg` |
| PDF en el que aparece | `dist/manual-2-sem-1.pdf` |
| Página PDF estimada | **p. 19** |
| Archivo Markdown fuente | `manuales/manual-2/unidades/u01/10-tema-1-2.md:87` |
| Tipo de placeholder | `ilustracion` |
| Espacio reservado | 0.5 página(s) |

## Descripción original del manual

> Diagrama de coordenadas mostrando: 1D con coche F1 en línea horizontal, x_inicial=0 y x_final=20m, vector desplazamiento de 20m. 2D con plano cartesiano, posición inicial (0,0), trayectoria curva hasta posición final (15,5), vector desplazamiento recto = 15.8m y trayectoria real curva = 18m por arriba. Etiquetas claras de los conceptos.
...
2. Guárdala como `assets/visuales/manual-2/u01/M2-u01-04.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M2-u01-04` ya no esté en estado `pendiente` corriendo:
