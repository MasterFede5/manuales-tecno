...
paginas_ocupa: 0.5
fuente_md: manuales/manual-2/unidades/u01/10-tema-1-1.md
fuente_md_linea: 50
imagen_destino: assets/visuales/manual-2/u01/M2-u01-03.jpg
...
**Tipo visual:** `cuadro-comparativo` · **Ocupa:** 0.5 pp · **Página PDF estimada:** 14
...
| Campo | Valor |
|---|---|
| ID estable | `M2-u01-03` |
| Archivo destino imagen | `assets/visuales/manual-2/u01/M2-u01-03.jpg` |
| PDF en el que aparece | `dist/manual-2-sem-1.pdf` |
| Página PDF estimada | **p. 14** |
| Archivo Markdown fuente | `manuales/manual-2/unidades/u01/10-tema-1-1.md:50` |
| Tipo de placeholder | `cuadro-comparativo` |
| Espacio reservado | 0.5 página(s) |

## Descripción original del manual

> Cuadro comparativo en dos columnas: ESCALARES (con ejemplos visuales: número en termómetro, peso en balanza, tiempo en cronómetro) vs VECTORIALES (con ejemplos: flecha de velocidad, vector posición, fuerza con dirección). Cada uno con definición operativa y ejemplo aplicado al coche F1.
...
2. Guárdala como `assets/visuales/manual-2/u01/M2-u01-03.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M2-u01-03` ya no esté en estado `pendiente` corriendo:
