...
tipo: ilustracion
paginas_ocupa: 1
fuente_md: manuales/manual-2/unidades/u04/00-portadilla.md
fuente_md_linea: 13
imagen_destino: assets/visuales/manual-2/u04/M2-u04-01.jpg
...
| Campo | Valor |
|---|---|
| ID estable | `M2-u04-01` |
| Archivo destino imagen | `assets/visuales/manual-2/u04/M2-u04-01.jpg` |
| PDF en el que aparece | `dist/manual-2-sem-1.pdf` |
| Página PDF estimada | **p. 204** |
| Archivo Markdown fuente | `manuales/manual-2/unidades/u04/00-portadilla.md:13` |
| Tipo de placeholder | `ilustracion` |
| Espacio reservado | 1 página(s) |

## Descripción original del manual

> Ilustración hero mostrando un motor de combustión seccionado con flechas de calor saliendo (rojo cálido), un radiador con líquido refrigerante azul, vapor escapando, termómetros midiendo temperaturas en distintos puntos. Conexión visual con el cartucho de CO2 del F1 escolar mostrando que también libera calor. Paleta cálida azul-naranja-rojo.
...
2. Guárdala como `assets/visuales/manual-2/u04/M2-u04-01.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M2-u04-01` ya no esté en estado `pendiente` corriendo:
