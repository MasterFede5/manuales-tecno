...
fuente_md_linea: 97
imagen_destino: assets/visuales/manual-2/u09/M2-u09-11.jpg
...
**Tipo visual:** `cuadro-comparativo` · **Ocupa:** 1 pp · **Página PDF estimada:** 195
...
| Campo | Valor |
|---|---|
| ID estable | `M2-u09-11` |
| Archivo destino imagen | `assets/visuales/manual-2/u09/M2-u09-11.jpg` |
| PDF en el que aparece | `dist/manual-2-sem-2.pdf` |
| Página PDF estimada | **p. 195** |
| Archivo Markdown fuente | `manuales/manual-2/unidades/u09/10-tema-9-3.md:97` |
| Tipo de placeholder | `cuadro-comparativo` |
| Espacio reservado | 1 página(s) |

## Descripción original del manual

> Cuadro comparativo de 6 tecnologías energéticas con columnas: capacidad instalada México 2024 (GW), LCOE (USD/MWh), CO₂ ciclo de vida (g/kWh), retorno energético (años), reto principal. Filas: solar PV, solar térmica, eólica, geotérmica, hidráulica gran escala, H₂ verde. Datos numéricos reales de SENER/AIE.
...
2. Guárdala como `assets/visuales/manual-2/u09/M2-u09-11.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M2-u09-11` ya no esté en estado `pendiente` corriendo:
