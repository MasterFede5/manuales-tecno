...
fuente_md_linea: 104
imagen_destino: assets/visuales/manual-2/u07/M2-u07-04.jpg
...
**Tipo visual:** `ilustracion` · **Ocupa:** 0.5 pp · **Página PDF estimada:** 59
...
2. Guárdala como `assets/visuales/manual-2/u07/M2-u07-04.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M2-u07-04` ya no esté en estado `pendiente` corriendo:
