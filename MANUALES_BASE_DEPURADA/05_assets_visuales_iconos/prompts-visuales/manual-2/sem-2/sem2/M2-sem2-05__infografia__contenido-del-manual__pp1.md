...
tipo: infografia
paginas_ocupa: 1
fuente_md: manuales/manual-2/semestre-2/03-mapa-contenidos.md
fuente_md_linea: 17
imagen_destino: assets/visuales/manual-2/sem2/M2-sem2-05.jpg
...
| Campo | Valor |
|---|---|
| ID estable | `M2-sem2-05` |
| Archivo destino imagen | `assets/visuales/manual-2/sem2/M2-sem2-05.jpg` |
| PDF en el que aparece | `dist/manual-2-sem-2.pdf` |
| Página PDF estimada | **p. 5** |
| Archivo Markdown fuente | `manuales/manual-2/semestre-2/03-mapa-contenidos.md:17` |
| Tipo de placeholder | `infografia` |
| Espacio reservado | 1 página(s) |

## Descripción original del manual

> Infografía vertical tipo mapa visual del semestre 2 del manual Física Albatros: en la parte superior, el título del case study 'Equipo F1 Albatros'. Debajo, una columna de 4 estaciones conectadas verticalmente, una por unidad (u06, u07, u08, u09), cada estación con su número, título, ícono temático y la herramienta que aporta al caso. Al pie, un entregable de portafolio final del semestre. Paleta azul Albatros + naranja en conectores.  
...
2. Guárdala como `assets/visuales/manual-2/sem2/M2-sem2-05.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M2-sem2-05` ya no esté en estado `pendiente` corriendo:
