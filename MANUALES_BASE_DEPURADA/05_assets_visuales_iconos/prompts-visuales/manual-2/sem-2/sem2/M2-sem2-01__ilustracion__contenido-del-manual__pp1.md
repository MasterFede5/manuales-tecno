...
tipo: ilustracion
paginas_ocupa: 1
fuente_md: manuales/manual-2/semestre-2/00-portada.md
fuente_md_linea: 18
imagen_destino: assets/visuales/manual-2/sem2/M2-sem2-01.jpg
...
| Campo | Valor |
|---|---|
| ID estable | `M2-sem2-01` |
| Archivo destino imagen | `assets/visuales/manual-2/sem2/M2-sem2-01.jpg` |
| PDF en el que aparece | `dist/manual-2-sem-2.pdf` |
| Página PDF estimada | **p. 1** |
| Archivo Markdown fuente | `manuales/manual-2/semestre-2/00-portada.md:18` |
| Tipo de placeholder | `ilustracion` |
| Espacio reservado | 1 página(s) |

## Descripción original del manual

> Ilustración hero de portada para el Semestre 2 del Manual 2: Física Albatros. Composición editorial vertical con el logo Albatros en la esquina superior derecha, título grande del manual, subtítulo, barra cromática azul Albatros + naranja pista, y al centro un escenario evocador del case study 'Equipo F1 Albatros' que conecta visualmente las unidades del semestre (Electromagnetismo, Mecánica de Fluidos, Óptica, Física Contemporánea). Tono editorial, sin photoreal, paleta azul Albatros con acento naranja.  
...
2. Guárdala como `assets/visuales/manual-2/sem2/M2-sem2-01.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M2-sem2-01` ya no esté en estado `pendiente` corriendo:
