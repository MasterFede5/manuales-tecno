...
tipo: linea-tiempo
paginas_ocupa: 1
fuente_md: manuales/manual-2/semestre-2/04-hilo-conductor.md
fuente_md_linea: 30
imagen_destino: assets/visuales/manual-2/sem2/M2-sem2-06.jpg
...
**Tipo visual:** `linea-tiempo` · **Ocupa:** 1 pp · **Página PDF estimada:** 6
...
2. Guárdala como `assets/visuales/manual-2/sem2/M2-sem2-06.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M2-sem2-06` ya no esté en estado `pendiente` corriendo:
