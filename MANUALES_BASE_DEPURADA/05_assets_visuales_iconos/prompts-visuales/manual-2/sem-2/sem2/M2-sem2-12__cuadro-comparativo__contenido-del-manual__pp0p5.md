...
paginas_ocupa: 0.5
fuente_md: manuales/manual-2/semestre-2/93-bibliografia-semestre.md
fuente_md_linea: 48
imagen_destino: assets/visuales/manual-2/sem2/M2-sem2-12.jpg
...
**Tipo visual:** `cuadro-comparativo` · **Ocupa:** 0.5 pp · **Página PDF estimada:** 232
...
| Campo | Valor |
|---|---|
| ID estable | `M2-sem2-12` |
| Archivo destino imagen | `assets/visuales/manual-2/sem2/M2-sem2-12.jpg` |
| PDF en el que aparece | `dist/manual-2-sem-2.pdf` |
| Página PDF estimada | **p. 232** |
| Archivo Markdown fuente | `manuales/manual-2/semestre-2/93-bibliografia-semestre.md:48` |
...
2. Guárdala como `assets/visuales/manual-2/sem2/M2-sem2-12.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M2-sem2-12` ya no esté en estado `pendiente` corriendo:
