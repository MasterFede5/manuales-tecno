...
tipo: mapa-mental
paginas_ocupa: 1
fuente_md: manuales/manual-2/unidades/u06/01-mapa-mental.md
fuente_md_linea: 9
imagen_destino: assets/visuales/manual-2/u06/M2-u06-02.jpg
...
**Tipo visual:** `mapa-mental` · **Ocupa:** 1 pp · **Página PDF estimada:** 11
...
| Campo | Valor |
|---|---|
| ID estable | `M2-u06-02` |
| Archivo destino imagen | `assets/visuales/manual-2/u06/M2-u06-02.jpg` |
| PDF en el que aparece | `dist/manual-2-sem-2.pdf` |
| Página PDF estimada | **p. 11** |
| Archivo Markdown fuente | `manuales/manual-2/unidades/u06/01-mapa-mental.md:9` |
| Tipo de placeholder | `mapa-mental` |
| Espacio reservado | 1 página(s) |

## Descripción original del manual

> Mapa mental con nodo central ELECTROMAGNETISMO y seis ramas: 1) ELECTROSTÁTICA (cargas, Coulomb, campo E, potencial); 2) ELECTRODINÁMICA (corriente, Ohm, circuitos serie/paralelo, Kirchhoff); 3) MAGNETISMO (imanes, B); 4) INDUCCIÓN (Oersted, Faraday, Henry, Lenz); 5) MAXWELL (4 ecuaciones, unificación); 6) ONDAS EM (espectro, luz, c).
...
2. Guárdala como `assets/visuales/manual-2/u06/M2-u06-02.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M2-u06-02` ya no esté en estado `pendiente` corriendo:
