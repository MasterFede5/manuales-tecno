...
tipo: infografia
paginas_ocupa: 1
fuente_md: manuales/manual-4/semestre-1/03-mapa-contenidos.md
fuente_md_linea: 18
imagen_destino: assets/visuales/manual-4/sem1/M4-sem1-05.jpg
...
| Campo | Valor |
|---|---|
| ID estable | `M4-sem1-05` |
| Archivo destino imagen | `assets/visuales/manual-4/sem1/M4-sem1-05.jpg` |
| PDF en el que aparece | `dist/manual-4-sem-1.pdf` |
| Página PDF estimada | **p. 10** |
| Archivo Markdown fuente | `manuales/manual-4/semestre-1/03-mapa-contenidos.md:18` |
| Tipo de placeholder | `infografia` |
| Espacio reservado | 1 página(s) |

## Descripción original del manual

> Infografía vertical tipo mapa visual del semestre 1 del manual Inteligencia Artificial Avanzada: en la parte superior, el título del case study 'Asistente Institucional Albatros'. Debajo, una columna de 5 estaciones conectadas verticalmente, una por unidad (u01, u02, u03, u04, u05), cada estación con su número, título, ícono temático y la herramienta que aporta al caso. Al pie, un entregable de portafolio final del semestre. Paleta azul Albatros + naranja en conectores.  
...
2. Guárdala como `assets/visuales/manual-4/sem1/M4-sem1-05.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M4-sem1-05` ya no esté en estado `pendiente` corriendo:
