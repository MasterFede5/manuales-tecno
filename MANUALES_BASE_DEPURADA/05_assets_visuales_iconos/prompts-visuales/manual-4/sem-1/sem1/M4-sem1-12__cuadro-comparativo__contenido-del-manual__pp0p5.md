...
paginas_ocupa: 0.5
fuente_md: manuales/manual-4/semestre-1/93-bibliografia-semestre.md
fuente_md_linea: 47
imagen_destino: assets/visuales/manual-4/sem1/M4-sem1-12.jpg
pagina_pdf_estimada: 396
...
**Tipo visual:** `cuadro-comparativo` · **Ocupa:** 0.5 pp · **Página PDF estimada:** 396
...
| Campo | Valor |
|---|---|
| ID estable | `M4-sem1-12` |
| Archivo destino imagen | `assets/visuales/manual-4/sem1/M4-sem1-12.jpg` |
| PDF en el que aparece | `dist/manual-4-sem-1.pdf` |
| Página PDF estimada | **p. 396** |
| Archivo Markdown fuente | `manuales/manual-4/semestre-1/93-bibliografia-semestre.md:47` |
...
2. Guárdala como `assets/visuales/manual-4/sem1/M4-sem1-12.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M4-sem1-12` ya no esté en estado `pendiente` corriendo:
