...
tipo: linea-tiempo
paginas_ocupa: 1
fuente_md: manuales/manual-4/semestre-1/04-hilo-conductor.md
fuente_md_linea: 31
imagen_destino: assets/visuales/manual-4/sem1/M4-sem1-06.jpg
...
**Tipo visual:** `linea-tiempo` · **Ocupa:** 1 pp · **Página PDF estimada:** 13
...
| Campo | Valor |
|---|---|
| ID estable | `M4-sem1-06` |
| Archivo destino imagen | `assets/visuales/manual-4/sem1/M4-sem1-06.jpg` |
| PDF en el que aparece | `dist/manual-4-sem-1.pdf` |
| Página PDF estimada | **p. 13** |
| Archivo Markdown fuente | `manuales/manual-4/semestre-1/04-hilo-conductor.md:31` |
| Tipo de placeholder | `linea-tiempo` |
| Espacio reservado | 1 página(s) |

## Descripción original del manual

> Línea de tiempo horizontal del semestre 1: en el extremo izquierdo, el problema inicial del case study 'Asistente Institucional Albatros'; en el centro, 5 hitos correspondientes a los episodios de cada unidad (u01, u02, u03, u04, u05); en el extremo derecho, el entregable final del portafolio del semestre. Cada hito con fecha tentativa (semana N), título corto y micro-ilustración temática.  
...
2. Guárdala como `assets/visuales/manual-4/sem1/M4-sem1-06.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M4-sem1-06` ya no esté en estado `pendiente` corriendo:
