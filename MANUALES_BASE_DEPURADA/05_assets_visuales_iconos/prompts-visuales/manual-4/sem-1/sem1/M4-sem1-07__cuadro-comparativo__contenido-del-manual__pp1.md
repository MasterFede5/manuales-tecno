...
paginas_ocupa: 1
fuente_md: manuales/manual-4/semestre-1/05-competencias.md
fuente_md_linea: 39
imagen_destino: assets/visuales/manual-4/sem1/M4-sem1-07.jpg
...
**Tipo visual:** `cuadro-comparativo` · **Ocupa:** 1 pp · **Página PDF estimada:** 16
...
| Campo | Valor |
|---|---|
| ID estable | `M4-sem1-07` |
| Archivo destino imagen | `assets/visuales/manual-4/sem1/M4-sem1-07.jpg` |
| PDF en el que aparece | `dist/manual-4-sem-1.pdf` |
| Página PDF estimada | **p. 16** |
| Archivo Markdown fuente | `manuales/manual-4/semestre-1/05-competencias.md:39` |
...
2. Guárdala como `assets/visuales/manual-4/sem1/M4-sem1-07.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M4-sem1-07` ya no esté en estado `pendiente` corriendo:
