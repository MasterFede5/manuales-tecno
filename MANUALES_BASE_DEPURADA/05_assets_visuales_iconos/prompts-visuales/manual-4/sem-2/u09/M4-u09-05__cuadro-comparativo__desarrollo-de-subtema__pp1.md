...
paginas_ocupa: 1
fuente_md: manuales/manual-4/unidades/u09/10-tema-9-3.md
fuente_md_linea: 152
imagen_destino: assets/visuales/manual-4/u09/M4-u09-05.jpg
...
| Campo | Valor |
|---|---|
| ID estable | `M4-u09-05` |
| Archivo destino imagen | `assets/visuales/manual-4/u09/M4-u09-05.jpg` |
| PDF en el que aparece | `dist/manual-4-sem-2.pdf` |
| Página PDF estimada | **p. 255** |
| Archivo Markdown fuente | `manuales/manual-4/unidades/u09/10-tema-9-3.md:152` |
| Tipo de placeholder | `cuadro-comparativo` |
| Espacio reservado | 1 página(s) |

## Descripción original del manual

> Cuadro a tamaño página con 6 productos educativos en filas (rúbrica, secuencia didáctica, examen, plan de clase, taller, recurso interactivo) × 5 columnas: estructura mínima · IA aporta · humano aporta · tiempo IA · tiempo humano. Bajo el cuadro, taxonomía Bloom visualizada como pirámide con verbos por nivel. Estilo blueprint educativo Albatros.
...
2. Guárdala como `assets/visuales/manual-4/u09/M4-u09-05.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M4-u09-05` ya no esté en estado `pendiente` corriendo:
