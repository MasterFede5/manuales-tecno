...
paginas_ocupa: 0.5
fuente_md: manuales/manual-4/semestre-2/02-carta-docente.md
fuente_md_linea: 56
imagen_destino: assets/visuales/manual-4/sem2/M4-sem2-04.jpg
...
| Campo | Valor |
|---|---|
| ID estable | `M4-sem2-04` |
| Archivo destino imagen | `assets/visuales/manual-4/sem2/M4-sem2-04.jpg` |
| PDF en el que aparece | `dist/manual-4-sem-2.pdf` |
| Página PDF estimada | **p. 8** |
| Archivo Markdown fuente | `manuales/manual-4/semestre-2/02-carta-docente.md:56` |
...
2. Guárdala como `assets/visuales/manual-4/sem2/M4-sem2-04.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M4-sem2-04` ya no esté en estado `pendiente` corriendo:
