...
fuente_md_linea: 26
imagen_destino: assets/visuales/manual-4/sem2/M4-sem2-02.jpg
...
| Campo | Valor |
|---|---|
| ID estable | `M4-sem2-02` |
| Archivo destino imagen | `assets/visuales/manual-4/sem2/M4-sem2-02.jpg` |
| PDF en el que aparece | `dist/manual-4-sem-2.pdf` |
| Página PDF estimada | **p. 2** |
| Archivo Markdown fuente | `manuales/manual-4/semestre-2/00-portada.md:26` |
...
2. Guárdala como `assets/visuales/manual-4/sem2/M4-sem2-02.jpg` (JPG @300 dpi, calidad alta).
...
4. Verifica que `M4-sem2-02` ya no esté en estado `pendiente` corriendo:
